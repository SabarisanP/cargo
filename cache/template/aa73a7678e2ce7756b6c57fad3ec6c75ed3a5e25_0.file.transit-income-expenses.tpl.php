<?php
/* Smarty version 3.1.34-dev-7, created on 2024-06-27 18:15:39
  from 'E:\xampp\htdocs\cargo\application\views\site\cargo\transit-income-expenses.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_667d5ef361ea36_01213472',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'aa73a7678e2ce7756b6c57fad3ec6c75ed3a5e25' => 
    array (
      0 => 'E:\\xampp\\htdocs\\cargo\\application\\views\\site\\cargo\\transit-income-expenses.tpl',
      1 => 1719492298,
      2 => 'file',
    ),
  ),
...
function content_667d5ef361ea36_01213472 (Smarty_Internal_Template $_smarty_tpl) {
                        ...
                        <?php if ($_smarty_tpl->tpl_vars['row']->value->cashbookType->code == 'HIRING' || $_smarty_tpl->tpl_vars['row']->value->cashbookType->code == 'ADVANCE') {?>
                            <tr>
                                ...
                                <td align="left">
                                    ...
                                    <?php $_smarty_tpl->_assignInScope('transactionModeDetails', '');?>
                                    <?php if ($_smarty_tpl->tpl_vars['row']->value->transactionMode->code == 'UPI') {?>
                                        <?php if (isNotNull($_smarty_tpl->tpl_vars['row']->value->bankDetails->name)) {?>
                                            <?php $_smarty_tpl->_assignInScope('transactionModeDetails', ((($_smarty_tpl->tpl_vars['transactionModeDetails']->value).('Name : ')).($_smarty_tpl->tpl_vars['row']->value->bankDetails->name)).('<br>'));?>
                                        <?php }?>
                                        <?php if (isNotNull($_smarty_tpl->tpl_vars['row']->value->bankDetails->accountNumber)) {?>
                                            <?php $_smarty_tpl->_assignInScope('transactionModeDetails', ((($_smarty_tpl->tpl_vars['transactionModeDetails']->value).('Account Number : ')).($_smarty_tpl->tpl_vars['row']->value->bankDetails->accountNumber)).('<br>'));?>
                                        <?php }?>
                                        <?php if (isNotNull($_smarty_tpl->tpl_vars['row']->value->addAttr1)) {?>
                                            <?php $_smarty_tpl->_assignInScope('transactionModeDetails', ((($_smarty_tpl->tpl_vars['transactionModeDetails']->value).('UPI : ')).(($_smarty_tpl->tpl_vars['row']->value->addAttr1))).('<br>'));?>
                                        <?php }?>
                                        <?php if (isNotNull($_smarty_tpl->tpl_vars['row']->value->addAttr2)) {?>
                                            <?php $_smarty_tpl->_assignInScope('transactionModeDetails', ((($_smarty_tpl->tpl_vars['transactionModeDetails']->value).('Ref# : ')).($_smarty_tpl->tpl_vars['row']->value->addAttr2)).('<br>'));?>
                                        <?php }?>
                                    <?php }?>

                                    <?php if ($_smarty_tpl->tpl_vars['row']->value->transactionMode->code == 'NBK') {?>
                                        <?php if (isNotNull($_smarty_tpl->tpl_vars['row']->value->bankDetails->name)) {?>
                                            <?php $_smarty_tpl->_assignInScope('transactionModeDetails', ((($_smarty_tpl->tpl_vars['transactionModeDetails']->value).('Name : ')).($_smarty_tpl->tpl_vars['row']->value->bankDetails->name)).('<br>'));?>
                                        <?php }?>
                                        <?php if (isNotNull($_smarty_tpl->tpl_vars['row']->value->bankDetails->accountNumber)) {?>
                                        ...
                                        <?php }?>
                                        <?php if (isNotNull($_smarty_tpl->tpl_vars['row']->value->addAttr1)) {?>
                                            <?php $_smarty_tpl->_assignInScope('transactionModeDetails', ((($_smarty_tpl->tpl_vars['transactionModeDetails']->value).('Account Holder Name : ')).((inr_format($_smarty_tpl->tpl_vars['row']->value->addAttr1)))).('<br>'));?>
                                        <?php }?>
                                        <?php if (isNotNull($_smarty_tpl->tpl_vars['row']->value->addAttr2)) {?>
                                            <?php $_smarty_tpl->_assignInScope('transactionModeDetails', ((($_smarty_tpl->tpl_vars['transactionModeDetails']->value).('Bank Name : ')).($_smarty_tpl->tpl_vars['row']->value->addAttr2)).('<br>'));?>
                                        <?php }?>
                                        <?php if (isNotNull($_smarty_tpl->tpl_vars['row']->value->addAttr3)) {?>
                                            <?php $_smarty_tpl->_assignInScope('transactionModeDetails', ((($_smarty_tpl->tpl_vars['transactionModeDetails']->value).('Ref# : ')).($_smarty_tpl->tpl_vars['row']->value->addAttr3)).('<br>'));?>
                                        <?php }?>
                                    <?php }?>

                                    <?php if ($_smarty_tpl->tpl_vars['row']->value->transactionMode->code == 'CHEQUE') {?>
                                        <?php if (isNotNull($_smarty_tpl->tpl_vars['row']->value->chequeDetails->payerDetails)) {?>
                                            <?php $_smarty_tpl->_assignInScope('transactionModeDetails', ((($_smarty_tpl->tpl_vars['transactionModeDetails']->value).('Payer : ')).($_smarty_tpl->tpl_vars['row']->value->chequeDetails->payerDetails)).('<br>'));?>
                                        <?php }?>
                                        <?php if (isNotNull($_smarty_tpl->tpl_vars['row']->value->chequeDetails->chequeNo)) {?>
                                            <?php $_smarty_tpl->_assignInScope('transactionModeDetails', ((($_smarty_tpl->tpl_vars['transactionModeDetails']->value).('Cheque Number : ')).($_smarty_tpl->tpl_vars['row']->value->chequeDetails->chequeNo)).('<br>'));?>
                                        <?php }?>
                                        <?php if (isNotNull($_smarty_tpl->tpl_vars['row']->value->chequeDetails->chequeDate)) {?>
                                            <?php $_smarty_tpl->_assignInScope('transactionModeDetails', ((($_smarty_tpl->tpl_vars['transactionModeDetails']->value).('Cheque Date : ')).((inr_format($_smarty_tpl->tpl_vars['row']->value->chequeDetails->chequeDate)))).('<br>'));?>
                                        <?php }?>
                                        <?php if (isNotNull($_smarty_tpl->tpl_vars['row']->value->chequeDetails->bankCity)) {?>
                                            <?php $_smarty_tpl->_assignInScope('transactionModeDetails', ((($_smarty_tpl->tpl_vars['transactionModeDetails']->value).('City : ')).($_smarty_tpl->tpl_vars['row']->value->chequeDetails->bankCity)).('<br>'));?>
                                        <?php }?>
                                        <?php if (isNotNull($_smarty_tpl->tpl_vars['row']->value->chequeDetails->bankDetails)) {?>
                                            <?php $_smarty_tpl->_assignInScope('transactionModeDetails', ((($_smarty_tpl->tpl_vars['transactionModeDetails']->value).('Bank Name : ')).($_smarty_tpl->tpl_vars['row']->value->chequeDetails->bankDetails)).('<br>'));?>
                                        <?php }?>
                                        <?php if (isNotNull($_smarty_tpl->tpl_vars['row']->value->chequeDetails->remarks)) {?>
                                            <?php $_smarty_tpl->_assignInScope('transactionModeDetails', ((($_smarty_tpl->tpl_vars['transactionModeDetails']->value).('Remarks : ')).($_smarty_tpl->tpl_vars['row']->value->chequeDetails->remarks)).('<br>'));?>
                                        <?php }?>
                                    <?php }?>

                                    <?php if (isNotNull($_smarty_tpl->tpl_vars['transactionModeDetails']->value)) {?>
                                        &nbsp;<span data-toggle="tooltip" data-placement="top" title="<?php echo $_smarty_tpl->tpl_vars['transactionModeDetails']->value;?>
...
"><i class="fa fa-info-circle"></i></span>
                                    <div class="btn-group btn-group-xs">
                                        <a class="delete pTip_top btn btn-default btn-sm" title="Delete" href="javascript:;" onclick="deleteExpense('<?php echo $_smarty_tpl->tpl_vars['row']->value->code;?>
')">
                                            <i class="fa fa-trash-o fa-lg"></i>
                                        </a>&nbsp;
                                        <a href="javascript:;" class="btn btn-default btn-sm" title="Edit" onclick='editExpense("<?php echo $_smarty_tpl->tpl_vars['row']->value->code;?>
")'><i class="fa fa-pencil igreen"></i> Edit</a>
                                    </div>
                                </td>
                            </tr>
                        <?php }?>
...
?>
                        <?php if ($_smarty_tpl->tpl_vars['row']->value->cashbookType->code != 'HIRING' && $_smarty_tpl->tpl_vars['row']->value->cashbookType->code != 'ADVANCE') {?>
                            <tr>
                                ...
                                <td align="left">
                                    <?php if ($_smarty_tpl->tpl_vars['row']->value->cashbookType->code == 'NA') {?>
                                        <?php echo $_smarty_tpl->tpl_vars['row']->value->paymentByContact->name;?>

                                    <?php } else { ?>
                                        <?php echo $_smarty_tpl->tpl_vars['row']->value->cashbookType->name;?>
...
echo (($tmp = @$_smarty_tpl->tpl_vars['row']->value->amount)===null||$tmp==='' ? '-' : $tmp);
} elseif ($_smarty_tpl->tpl_vars['row']->value->cashbookType->code == 'NA') {
echo (($tmp = @$_smarty_tpl->tpl_vars['row']->value->amount)===null||$tmp==='' ? '-' : $tmp);
} else { ?>-<?php }?></td>
                                                                                                <td align="right">
                                    <span class="pull-left" data-toggle="tooltip" data-placement="top" title="<?php echo $_smarty_tpl->tpl_vars['row']->value->user->name;?>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <input type="checkbox" checked id="expense-type-cb" class="bsn_switch" data-on-text="Expense" data-off-text="Income" <?php if ($_smarty_tpl->tpl_vars['cargo_setting']->value->userAccountModel->code == 'TXRT') {?>disabled<?php }?>>
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="<?php if ($_smarty_tpl->tpl_vars['cargo_setting']->value->userAccountModel->code == 'TXRT') {?>hide<?php }?>">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group text-left hide" id="income-head-panel">
                                ...
                                <select id="expense-income" class="form-control">
                                    ...
                                    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['triphead']->value, 'row');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['row']->value) {
?> 
                                        <?php if ($_smarty_tpl->tpl_vars['row']->value->transactionType == 'Cr') {?>
                                            <?php if (preg_match("/(HIRING|ADVANCE)/i",$_smarty_tpl->tpl_vars['row']->value->code) == 0) {?>
...
foreach ($_from as $_smarty_tpl->tpl_vars['row']->value) {
?> 
                                        <?php if ($_smarty_tpl->tpl_vars['row']->value->transactionType == 'Dr') {?>
                                            <?php if (preg_match("/(HIRING|ADVANCE)/i",$_smarty_tpl->tpl_vars['row']->value->code) == 0) {?>
                                                <option value="<?php echo $_smarty_tpl->tpl_vars['row']->value->code;?>
"><?php echo $_smarty_tpl->tpl_vars['row']->value->name;?>
</option>
...
foreach ($_from as $_smarty_tpl->tpl_vars['val']->value) {
?>
                                            <?php if (in_array('EXPLGR',$_smarty_tpl->tpl_vars['val']->value->contactCategory->tag)) {?>
                                                <option value="<?php echo $_smarty_tpl->tpl_vars['val']->value->code;?>
"><?php echo $_smarty_tpl->tpl_vars['val']->value->name;?>
</option>
                                            <?php }?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
    ...
    <div class="col-md-5 b_l">
        <form id="hire-adv-form" onsubmit="return false;">
            <?php if ((count($_smarty_tpl->tpl_vars['expensesData']->value) > 0) && ($_smarty_tpl->tpl_vars['namespace']->value == 'seenutransports')) {?>
                <button class="btn btn-success btn-sm pull-right" type="button" onclick="printHireChallan('<?php echo $_smarty_tpl->tpl_vars['transitCode']->value;?>
', '<?php echo $_smarty_tpl->tpl_vars['ogplType']->value;?>
')">Print</button>
            <?php }?>
                        <div class="row">
                <div class="col-md-12 <?php if (!$_smarty_tpl->tpl_vars['cashbookType']->value['HIRING'] || ($_smarty_tpl->tpl_vars['cargo_setting']->value->userAccountModel->code == 'TXRT' && $_smarty_tpl->tpl_vars['vehicles']->value->ownershipType->code != 'HIRE')) {?>hide<?php }?>" id="hire-view">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div id="hire-view-amt"><?php echo $_smarty_tpl->tpl_vars['cashbookType']->value['HIRING']->amount;?>
</div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div id="hire-view-pay-mode"><?php echo $_smarty_tpl->tpl_vars['cashbookType']->value['HIRING']->transactionMode->name;?>
</div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div id="hire-view-contact"><?php echo $_smarty_tpl->tpl_vars['cashbookType']->value['HIRING']->paymentToContact->name;?>
</div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-12 <?php if ($_smarty_tpl->tpl_vars['cashbookType']->value['HIRING'] || ($_smarty_tpl->tpl_vars['cargo_setting']->value->userAccountModel->code == 'TXRT' && $_smarty_tpl->tpl_vars['vehicles']->value->ownershipType->code != 'HIRE')) {?>hide<?php }?>" id="hire-inp">
                    <div class="form-group" style="border-bottom: 1px solid #ced4da;padding-bottom: 10px;">
                        <div class="row">
                            <div class="col-md-5">
                                <label class="control-label" for="">Hiring Amount</label>
                                <input type="number" class="form-control" id="hire-amt" placeholder="Amount" step="any" maxlength="10" >
                            </div>
                            <div class="col-md-5">
                                <div class="form-group">
                                    <label class="">Payment Mode</label>
...
foreach ($_from as $_smarty_tpl->tpl_vars['val']->value) {
?>
                                            <?php if ($_smarty_tpl->tpl_vars['val']->value->contactCategory->code == 'BRCH') {?>
                                                <option value="<?php echo $_smarty_tpl->tpl_vars['val']->value->code;?>
"><?php echo $_smarty_tpl->tpl_vars['val']->value->name;?>
</option>
                                            <?php }?>
...
foreach ($_from as $_smarty_tpl->tpl_vars['val']->value) {
?>
                                            <?php if ($_smarty_tpl->tpl_vars['val']->value->contactCategory->code == 'TRANS') {?>
                                                <option value="<?php echo $_smarty_tpl->tpl_vars['val']->value->code;?>
"><?php echo $_smarty_tpl->tpl_vars['val']->value->name;?>
</option>
                                            <?php }?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                ...
                                <div class="col-md-12 <?php if (!$_smarty_tpl->tpl_vars['cashbookType']->value['ADVANCE'] || ($_smarty_tpl->tpl_vars['cargo_setting']->value->userAccountModel->code == 'TXRT' && in_array($_smarty_tpl->tpl_vars['cargoActivityType']->value,array('OTFD','INTRNT')) && $_smarty_tpl->tpl_vars['vehicles']->value->ownershipType->code == 'OWN')) {?>hide<?php }?>" id="advance-view">
                    <div class="form-group" style="border-bottom: 1px solid #ced4da;padding-bottom: 10px;">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="control-label" for="">Advance Amount</label>
                                    <div id="adv-view-amt"><?php echo $_smarty_tpl->tpl_vars['cashbookType']->value['ADVANCE']->amount;?>
</div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="">Payment Mode</label>
                                    <div id="adv-view-pay-mode"><?php echo $_smarty_tpl->tpl_vars['cashbookType']->value['ADVANCE']->transactionMode->name;?>
</div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="">Payment By</label>
                                    <div id="adv-view-pay-by"><?php echo $_smarty_tpl->tpl_vars['cashbookType']->value['ADVANCE']->paymentByContact->name;?>
</div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="">Payment To</label>
                                    <div id="adv-view-pay-to"><?php echo $_smarty_tpl->tpl_vars['cashbookType']->value['ADVANCE']->paymentToContact->name;?>
</div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-12 <?php if ($_smarty_tpl->tpl_vars['cashbookType']->value['ADVANCE'] || ($_smarty_tpl->tpl_vars['cargo_setting']->value->userAccountModel->code == 'TXRT' && in_array($_smarty_tpl->tpl_vars['cargoActivityType']->value,array('OTFD','INTRNT')) && $_smarty_tpl->tpl_vars['vehicles']->value->ownershipType->code == 'OWN')) {?>hide<?php }?>" id="advance-inp">
                    <div class="form-group" style="border-bottom: 1px solid #ced4da;padding-bottom: 10px;">
                        <div class="row">
                            <div class="col-md-5">
                                <label class="control-label" for="">Advance Amount</label>
                ...
                <div class="col-md-12">
                    ...
                    <div class="table table-responsive">
                        <table class="table no-bordered">
                            ...
                            <tbody>
                                <?php $_smarty_tpl->_assignInScope('hire_amt', 0);?>
                                <?php $_smarty_tpl->_assignInScope('adv_amt', 0);?>
                                <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['cashbookType']->value, 'row', false, 'key');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['key']->value => $_smarty_tpl->tpl_vars['row']->value) {
?>
                                    <?php if ($_smarty_tpl->tpl_vars['row']->value->cashbookType->code == 'HIRING') {?>
                                        <?php $_smarty_tpl->_assignInScope('hire_amt', $_smarty_tpl->tpl_vars['hire_amt']->value+$_smarty_tpl->tpl_vars['row']->value->amount);?>
                                    <?php }?>
                                    <?php if ($_smarty_tpl->tpl_vars['row']->value->cashbookType->code == 'ADVANCE') {?>
                                        <?php $_smarty_tpl->_assignInScope('adv_amt', $_smarty_tpl->tpl_vars['adv_amt']->value+$_smarty_tpl->tpl_vars['row']->value->amount);?>
                                    <?php }?>
                                <?php
}
}
...
?>
                                                    <?php if ($_smarty_tpl->tpl_vars['row']->value->cashbookType->code == 'HIRING' || $_smarty_tpl->tpl_vars['row']->value->cashbookType->code == 'ADVANCE') {?>
                                                        <tr>
                                                            <td style="border-bottom: 1px dashed #DDDDDD;"><?php echo $_smarty_tpl->tpl_vars['row']->value->cashbookType->name;?>
</td>
                                                            <td style="border-bottom: 1px dashed #DDDDDD;"><?php echo inr_format($_smarty_tpl->tpl_vars['row']->value->amount);?>
</td>
                                                        </tr>
                                                    <?php }?>
                                                <?php
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                                <tr>
                                                    <td>Total</td>
                                                    <td><?php echo inr_format(($_smarty_tpl->tpl_vars['adv_amt']->value-$_smarty_tpl->tpl_vars['hire_amt']->value));?>
</td>
                                                </tr>
                                            </tbody>
                                        </table>
...
?>
                                                    <?php if (($_smarty_tpl->tpl_vars['row']->value->cashbookType->code != 'HIRING') && ($_smarty_tpl->tpl_vars['row']->value->cashbookType->code != 'ADVANCE')) {?>
                                                        <?php $_smarty_tpl->_assignInScope('hire_amt', $_smarty_tpl->tpl_vars['hire_amt']->value+$_smarty_tpl->tpl_vars['row']->value->amount);?>
                                                        <tr>
                                                            <td style="border-bottom: 1px dashed #DDDDDD;"><?php if ($_smarty_tpl->tpl_vars['row']->value->cashbookType->code == 'NA') {
echo $_smarty_tpl->tpl_vars['row']->value->paymentByContact->name;
} else {
echo $_smarty_tpl->tpl_vars['row']->value->cashbookType->name;
}?></td>
                                                            <td style="border-bottom: 1px dashed #DDDDDD;"><?php echo inr_format(sigma($_smarty_tpl->tpl_vars['row']->value->amount,$_smarty_tpl->tpl_vars['brn_amt']->value));?>
</td>
                                                        </tr>
                                                    <?php }?>
                                                <?php
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                                <tr>
                                                    <td>Total</td>
                                                    <td><?php echo inr_format($_smarty_tpl->tpl_vars['brn_amt']->value);?>
</td>
                                                </tr>
                                            </tbody>
                                        </table>
...
<?php echo '<script'; ?>
>
    var expensesData = <?php echo json_encode($_smarty_tpl->tpl_vars['expensesData']->value);?>
;
    var vehicleOwnershipType = <?php echo json_encode($_smarty_tpl->tpl_vars['vehicles']->value);?>
;
    var transitCode = <?php echo json_encode($_smarty_tpl->tpl_vars['transitCode']->value);?>
;
...
;
    var cargoActivityType = <?php echo json_encode($_smarty_tpl->tpl_vars['cargoActivityType']->value);?>
;

    $(document).ready(function(){
        $('#hire-amt ,#adv-amt').on('input', function() {
        ...
        //ref no  
        $('#adv-netbanking-details, #hire-netbanking-details ').on('input', function() {
            if ($(this).val().length > 18) {
                $(this).val($(this).val().slice(0, 10));
            }
        });

        $("#hire-netbanking-accholder").on("change", function() {
        ...
        $("#adv-netbanking-accholder").on("change", function() {
            var inputValue = $(this).val();
            if(!/^[a-zA-Z]+$/.test(inputValue)) {
                alert("Please enter only letters.");
                $(this).val('');
    ...
    function clearExpense() {
        $('#expense-code, #hire-code, #advance-code, #expense-amount, #seenu-expense-amount, #hire-amt, #adv-amt ,#adv-netbanking-orgbank ,#adv-netbanking-accholder, #adv-netbanking-bankname, #adv-netbanking-details,#hire-netbanking-accholder ,#hire-netbanking-orgbank,#hire-netbanking-bankname ,#hire-netbanking-details ,#adv-upi-orgbank ,#adv-upi-id ,#adv-upi-details, #hire-upi-orgbank ,#hire-upi-id ,#hire-upi-details').val('');
        $('#hire-cheque-payer ,#hire-cheque-no ,#hire-cheque-date ,#hire-cheque-bankcity ,#hire-cheque-bankname,#hire-cheque-remarks ').val('');
        $('#adv-cheque-payer ,#adv-cheque-no ,#adv-cheque-date ,#adv-cheque-bankcity ,#adv-cheque-bankname ,#adv-cheque-remarks').val('');
    ...
    function updateExpense() {
        $('.inp_error').removeClass('inp_error');
        var Hiremode = $('#hire-mode').val();
        var AdvanceMode =$('#adv-mode').val();

        var Hireamount = $('#hire-amt').val();
        var AdvanceAmount =$('#adv-amt').val();
        var erros =0;

        if(Hireamount !=''){
            if(Hiremode ==''){
                $('#hire-mode').addClass('inp_error');  
                erros ++;         
            }else{
                $('#hire-mode').removeClass('inp_error');
            }
        }

        if(AdvanceAmount !=''){
            if(AdvanceMode ==''){
                $('#adv-mode').addClass('inp_error');  
                erros ++;
            }else{
                $('#adv-mode').removeClass('inp_error');
            }
        }
        ...
        if ($('#expense-amount').val() != '' && cargo_setting.userAccountModel.code != 'TXRT') {
            ...
            incomeExpense.user = {};
            incomeExpense.user.code = '<?php echo $_smarty_tpl->tpl_vars['usr_login_id']->value;?>
';
            ...
            if (incomeExpense.transactionMode.code == 'UPI') {
                ...
                incomeExpense.chequeDetails.organization.code = '<?php echo $_smarty_tpl->tpl_vars['login_branch']->value;?>
';
...
';
        ...
        if ($('#hire-amt').val() != '' || (cargo_setting.userAccountModel.code == 'TXRT' && $('#hire-amt').val() != '' && vehicleOwnershipType.ownershipType.code == 'HIRE')) {
            ...
            hire.user = {};
            hire.user.code = '<?php echo $_smarty_tpl->tpl_vars['usr_login_id']->value;?>
';
            ...
            if (hire.transactionMode.code == 'UPI') {
                ...
                hire.chequeDetails.organization.code = '<?php echo $_smarty_tpl->tpl_vars['login_branch']->value;?>
';
        ...
        if ($('#adv-amt').val() != '' || (cargo_setting.userAccountModel.code == 'TXRT' && $('#adv-amt').val() != '' && $.inArray(cargoActivityType, ['OTFD', 'INTRNT']) == -1 && vehicleOwnershipType.ownershipType.code != 'OWN')) {
            ...
            advance.user = {};
            advance.user.code = '<?php echo $_smarty_tpl->tpl_vars['usr_login_id']->value;?>
';
...
';
        ...
        $.ajax({
            type: 'POST',
            dataType: 'json',
            url: base_url + 'cargo/update-ogpl-income-expense',
            data: data,

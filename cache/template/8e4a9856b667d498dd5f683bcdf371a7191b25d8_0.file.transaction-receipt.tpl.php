<?php
/* Smarty version 3.1.34-dev-7, created on 2024-05-29 12:15:10
  from 'E:\xampp\htdocs\cargo\application\views\site\payment\transaction-receipt.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_6656cef68e87a5_34430076',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '8e4a9856b667d498dd5f683bcdf371a7191b25d8' => 
    array (
      0 => 'E:\\xampp\\htdocs\\cargo\\application\\views\\site\\payment\\transaction-receipt.tpl',
      1 => 1716451515,
      2 => 'file',
    ),
  ),
...
function content_6656cef68e87a5_34430076 (Smarty_Internal_Template $_smarty_tpl) {
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-3">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" name="fromDate" class="form-control sdate" id="txn_rcpt_date_range" readonly placeholder="Today" value="<?php echo implode(' | ',array_filter(array(smarty_modifier_date_format($_smarty_tpl->tpl_vars['ffromDate']->value,'%d-%m-%Y'),smarty_modifier_date_format($_smarty_tpl->tpl_vars['ftoDate']->value,'%d-%m-%Y'))));?>
">
                                                    ...
                                                    <div class="form-group col-md-2">
                                                        ...
                                                        <div class="input-group col-md-12">
                                                            <select id="txn-rcpt-users" class="form-control">
                                                                ...
                                                                <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['users']->value, 'val');
if ($_from !== null) {
                                                    ...
                                                    <div class="form-group col-md-2">
                                                        ...
                                                        <div class="input-group col-md-12">
                                                            <select id="txn-rcpt-branch" class="form-control"
                                                                <?php if ($_smarty_tpl->tpl_vars['action_rights']->value['EBL-ALL-BRANCH'] != 1) {?>disabled="disabled"
                                                                <?php }?>>
...
"
                                                                        <?php if ($_smarty_tpl->tpl_vars['userOrganization']->value == $_smarty_tpl->tpl_vars['row']->value->code) {?>selected<?php }?>>
                        ...
                        <table class="table table-bordered" width="98%" id="txn-rcpt-lr-table">
                            <thead>
                                <tr class="success">
                                    ...
                                    <td align="center" class="sticky-row-top"><?php echo lang('cargo_code_term');?>
</td>
                                    <td align="center" class="sticky-row-top">Booked Date</td>
                                    <td align="center" class="sticky-row-top"><?php echo lang('booking_from_term');?>
</td>
                                    <td align="center" class="sticky-row-top"><?php echo lang('booking_to_label');?>
</td>
                            ...
                            <tbody class="body_table" id="vendor-customer-list-row">
                                <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['pendingDeliveryList']->value, 'row', false, 'key');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['key']->value => $_smarty_tpl->tpl_vars['row']->value) {
?>
                                    <tr class="hide" data-mobile="<?php echo $_smarty_tpl->tpl_vars['row']->value->to_customer_mobile;?>
">
                                        <td align="center">
                                            <input type="checkbox" onclick="getDemurrageDetails();" class="lr-check" value="<?php echo $_smarty_tpl->tpl_vars['row']->value->cargo_code;?>
" data-balanceamount="<?php echo $_smarty_tpl->tpl_vars['row']->value->balance_amount;?>
">
                                        </td>
...
")'><?php echo $_smarty_tpl->tpl_vars['row']->value->cargo_code;?>
                                        ...
                                        <td align="left"><?php echo $_smarty_tpl->tpl_vars['cargostatus']->value[$_smarty_tpl->tpl_vars['row']->value->cargo_status_code];?>
</td>
                                        ...
                                        <td align="right"><?php echo inr_format(($_smarty_tpl->tpl_vars['row']->value->total_amount+$_smarty_tpl->tpl_vars['row']->value->other_charges));?>
</td>
                                        <td align="right"><?php echo inr_format(($_smarty_tpl->tpl_vars['row']->value->total_amount_paid));?>
</td>
                                        <td align="right"><?php echo inr_format(($_smarty_tpl->tpl_vars['row']->value->total_amount+$_smarty_tpl->tpl_vars['row']->value->other_charges-$_smarty_tpl->tpl_vars['row']->value->customer_tds_tax-$_smarty_tpl->tpl_vars['row']->value->total_amount_paid));?>
</td>
                                    </tr>
                                <?php
}
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                        ...
                        <table class="table table-bordered" width="98%" id="txn-rcpt-up-inv-table">
                            ...
                            <tbody class="body_table">
                                ...
                                <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['unpaidinvoice']->value, 'row');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['row']->value) {
?>

                                    <tr class="hide" data-user="<?php echo $_smarty_tpl->tpl_vars['row']->value->user->code;?>
">
                                        <td align="center">
                                            <input type="checkbox" class="inv-check" value="<?php echo $_smarty_tpl->tpl_vars['row']->value->code;?>
"
                                                data-balanceamount="<?php echo $_smarty_tpl->tpl_vars['row']->value->balanceAmount;?>
">
                                        </td>
                                        <td align="left"><?php echo $_smarty_tpl->tpl_vars['row']->value->code;?>
</td>
 ...
 to
                                                <?php echo $_smarty_tpl->tpl_vars['row']->value->transactiontxn-'rcpt'-smarty_modifier_date_format('vendorndDate',$_smarty_tpl->tpl_vars['ns_date_format']->value);?>

                                            <?php } else { ?>
                                                -
                                            <?php }?>
                                        </td>
                                        <td align="right"><?php echo inr_format($_smarty_tpl->tpl_vars['row']->value->transactionAmount);?>
</td>
                                        <td align="right"><?php echo inr_format($_smarty_tpl->tpl_vars['row']->value->balanceAmount);?>
</td>
                                        <td width="20%">
                                            <input type="hidden" id="hid-inv-total-balance" value="<?php echo $_smarty_tpl->tpl_vars['row']->value->balanceAmount;?>
">
                                            <div class="d-flex hide txn-rcpt-advance" style="align-items: center;">
                                                <div style="width: 70%;">
                                                    <input type="number" disabled class="form-control amount<?php echo $_smarty_tpl->tpl_vars['row']->value->code;?>
"
                                                ...
                                                <div>
                                                    <a href="javascript:;" class="btn btn-sm"
                                                        onclick="payUsingAdvanceDialog('<?php echo $_smarty_tpl->tpl_vars['row']->value->code;?>
', '<?php echo $_smarty_tpl->tpl_vars['row']->value->balanceAmount;?>
')"><i
        ...
        <div class="row">
            ...
            <div class="form-group col-md-3">
                ...
                <select id="txn-rcpt-txn-mode" class="form-control">
                    ...
                    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['transactionmode']->value, 'val', false, 'k');
if ($_from !== null) {
...
foreach ($_from as $_smarty_tpl->tpl_vars['val']->value) {
?>
                            <?php if ($_smarty_tpl->tpl_vars['val']->value->accountType->code != 'CASH') {?>
                                <option value="<?php echo $_smarty_tpl->tpl_vars['val']->value->code;?>
"><?php echo $_smarty_tpl->tpl_vars['val']->value->name;?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                    ...
                    <input type="hidden" id="txn-rcpt-chq-branch-hid" value="<?php echo $_smarty_tpl->tpl_vars['login_branch']->value;?>
">
                </div>
...
>
    localStorage.clear();
    var customersData = <?php echo json_encode($_smarty_tpl->tpl_vars['customers']->value);?>

    var vendorsData = <?php echo json_encode($_smarty_tpl->tpl_vars['vendors']->value);?>

    var allVendorsData = <?php echo json_encode($_smarty_tpl->tpl_vars['allvendors']->value);?>

<?php
/* Smarty version 3.1.34-dev-7, created on 2024-06-13 13:24:28
  from 'E:\xampp\htdocs\cargo\application\views\site\profile\edit-profile.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_666aa5b4eac352_15397717',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e400ee433bebebc17f31825bbc7cdc617e6ce622' => 
    array (
      0 => 'E:\\xampp\\htdocs\\cargo\\application\\views\\site\\profile\\edit-profile.tpl',
      1 => 1716451522,
      2 => 'file',
    ),
  ),
...
function content_666aa5b4eac352_15397717 (Smarty_Internal_Template $_smarty_tpl) {
                                                ...
                                                <ul class="user_list">
                                                    <li>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6"><?php echo $_smarty_tpl->tpl_vars['pro_usr']->value->name;?>
</div>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6"><?php echo $_smarty_tpl->tpl_vars['pro_usr']->value->email;?>
</div>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-2">
                                                                <?php echo $_smarty_tpl->tpl_vars['pro_usr']->value->mobile;?>

                                                            </div>
                                                            <div class="col-md-6">
                                                                <?php if ($_smarty_tpl->tpl_vars['pro_usr']->value->mobileVerifiedFlag == 1) {?>
                                                    ...
                                                    <li>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6"><?php echo $_smarty_tpl->tpl_vars['pro_usr']->value->group->name;?>
</div>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6"><?php echo $_smarty_tpl->tpl_vars['pro_usr']->value->paymentType->name;?>
</div>
                                                        </div>
                                                    </li>
                                                    <input type='hidden' value='<?php echo $_smarty_tpl->tpl_vars['pro_usr']->value->paymentType->code;?>
' id='pg_code'>
                                                    <input type='hidden' value='<?php echo $_smarty_tpl->tpl_vars['pro_usr']->value->code;?>
' id='usr_code'>
                                                </ul>  
                                            </div>
                                                ...
                                                <form id="change-profile" role="form" class="pd_tp_20 form-horizontal">
                                                    ...
                                                    <?php if ($_REQUEST['status'] != '') {?> 
                                                        <div class="text-center" style="margin-left: 10px; margin-right: 5px;">                                                            
                                                            <?php if ($_REQUEST['status'] == 'confirm') {?>
                                                                <div class="alert alert-success">Your recharge success.</div>
                                                            <?php } elseif ($_REQUEST['status'] == 'fail') {?>    
                                                                <div class="alert alert-danger">Sorry! your recharge failed. Transaction code : <?php echo $_REQUEST['code'];?>
 </div>
                                                            <?php } elseif ($_REQUEST['status'] == 'invalid') {?>    
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <label class="col-xs-6 mob control-label" for="group" style="text-align:justify"><span class="light-txt"> <i class="fa fa-inr"></i>&nbsp;<?php echo $_smarty_tpl->tpl_vars['balance']->value;?>
</span> 
                                                        <?php if ($_smarty_tpl->tpl_vars['pro_usr']->value->paymentType->name == 'Payment Pre Paid') {?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-xs-6">
                                                            <label class="col-xs-4 mob control-label lab_tkn" for="group" style="text-align:justify"><span class="light-txt" id="tkn_txt"><?php echo $_smarty_tpl->tpl_vars['pro_usr']->value->apiToken;?>
</span></label>
                                                            <input type="text" placeholder="New API Token" id="token" class="form-control" value="" maxlength="15">
                                                        </div>
                                                        <?php if ($_smarty_tpl->tpl_vars['action_rights']->value['CRE-TKN'] > 0) {?>
                                        ...
                                        <div id="password_setting" class="tab-pane fade">
                                            <div>
                                                ...
                                                <form id="change-password" role="form" class="pro_edt form-horizontal">
                                                    ...
                                                    <?php if ($_smarty_tpl->tpl_vars['action_rights']->value['PRF-CHG-PWD'] > 0) {?>   
                                                    <div class="align-right" id="pwd-form-bttons">
                                                        <button class="btn btn-success" type="button" data-hash="<?php echo $_smarty_tpl->tpl_vars['token']->value;?>
" <?php if ($_smarty_tpl->tpl_vars['action_rights']->value['PRF-CHG-PWD'] == 1) {?>onclick="changePassword();<?php }?>">Save</button>
                                                    </div>
                                                    <?php }?>
                                                    </form>
                                                </div>
                ...
                <?php if ($_smarty_tpl->tpl_vars['action_rights']->value['ALRT-SUBS'] > 0) {?> 
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-7 pt10">
                                ...
                                <?php if (count($_smarty_tpl->tpl_vars['subscription']->value['EZBOT'])) {?>
                                    <br>
                                    <p class="bold">Active Devices</p>
                                    <div class="row">
                                        <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['subscription']->value['EZBOT'], 'subs');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['subs']->value) {
?>
                                            <div class="col-md-6 m-t-5" data-udid="<?php echo $_smarty_tpl->tpl_vars['subs']->value->udid;?>
" data-gcmtoken="<?php echo $_smarty_tpl->tpl_vars['subs']->value->gcmToken;?>
">
                                                <?php echo $_smarty_tpl->tpl_vars['subs']->value->model;?>
 <?php if ($_smarty_tpl->tpl_vars['subs']->value->os) {?>(<?php echo $_smarty_tpl->tpl_vars['subs']->value->os;?>
)<?php }?>
                                            </div>
                                            <div class="col-md-6 m-t-5">
                                                <a href="javascript:;" class="text-danger bold" onclick="revokeAuthToken('EZBOT', '<?php echo $_smarty_tpl->tpl_vars['subs']->value->code;?>
')">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="ov_fl_m_150">
                                    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['notification']->value, 'row');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['row']->value) {
?>
                                        <label class="">
                                    <input type="checkbox"  class="he_25 form-check-input usr-notify" data-code="<?php echo $_smarty_tpl->tpl_vars['row']->value->code;?>
" id="<?php echo $_smarty_tpl->tpl_vars['row']->value->code;?>
" <?php if ($_smarty_tpl->tpl_vars['row']->value->activeFlag == 1) {?>checked<?php }?>> <?php echo $_smarty_tpl->tpl_vars['row']->value->name;?>
            ...
            <div class="col-lg-6 p_l_n">
                <div>
                    ...
                    <select id="sel_gateway" class="form-control col-md-6">
                        ...
                        <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['providers']->value, 'row', false, NULL, 'o', array (
));
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['row']->value) {
?>
            ...
            <form role="form" id="frmnewmobile" class="form-horizontal "> 
                ...
                <div class="row">                    
                    <div class="col-md-12">
                        ...
                        <input  placeholder="Mobile Number" value="<?php echo $_smarty_tpl->tpl_vars['pro_usr']->value->mobile;?>

<?php
/* Smarty version 3.1.34-dev-7, created on 2024-05-26 19:19:25
  from 'E:\xampp\htdocs\cargo\application\views\site\user\footer.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_66533de5b38da4_33887152',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '5a72dfdf8b433dfa39735176c5ed7830f243fd4b' => 
    array (
      0 => 'E:\\xampp\\htdocs\\cargo\\application\\views\\site\\user\\footer.tpl',
      1 => 1716451522,
      2 => 'file',
    ),
  ),
...
function content_66533de5b38da4_33887152 (Smarty_Internal_Template $_smarty_tpl) {
?>    <!-- Start footer section -->
    ...
    <!-- JS ============================================= -->
    <?php echo '<script'; ?>
 src="assets/js/login/vendor/jquery-2.2.4.min.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="assets/js/login/vendor/popper.min.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="assets/js/login/jquery.easing.1.3.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="assets/js/login/vendor/bootstrap.min.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="assets/js/login/jquery.parallax-scroll.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="assets/js/login/dopeNav.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="assets/js/login/owl.carousel.min.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="assets/js/login/jquery.stellar.min.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="assets/js/login/jquery.counterup.min.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="assets/js/login/waypoints.min.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="assets/js/login/main.js?<?php echo $_smarty_tpl->tpl_vars['asset_ver']->value;?>
"><?php echo '</script'; ?>
>

<?php
/* Smarty version 3.1.34-dev-7, created on 2024-06-10 14:48:02
  from 'E:\xampp\htdocs\cargo\application\views\site\payment\transit-record-topay-payment.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_6666c4ca0d53d1_84746506',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '1dfe41ae1e66928b4ce87b7abe63dd7195ab002d' => 
    array (
      0 => 'E:\\xampp\\htdocs\\cargo\\application\\views\\site\\payment\\transit-record-topay-payment.tpl',
      1 => 1717597869,
      2 => 'file',
    ),
  ),
...
function content_6666c4ca0d53d1_84746506 (Smarty_Internal_Template $_smarty_tpl) {
?><div class="brand_top">
    <h3><?php echo iflang('Transit Record Topay Payment');?>
</h3>
</div>
...
" <?php if ($_smarty_tpl->tpl_vars['login_station']->value == $_smarty_tpl->tpl_vars['station']->value['code']) {?>selected="" <?php }?>><?php echo $_smarty_tpl->tpl_vars['station']->value['name'];?>
</option>
                                                                <?php
}
}
...
>
    ...
    function searchtransitTopay() {
        ...
        $.ajax({
            type: "POST",
            dataType: 'html',
            url: base_url + "payment/transit-record-topay-payment-list",
            data: data,
    ...
    function showTransitReportDialog(ogpl, org_code, rel_orgCode) {
        ...
        $.ajax({
            type: "POST",
            dataType: 'html',
            url: base_url + "payment/transit-record-topay-payment-details-list",
            data: data,
            success: function(response) {
    ...
    function confirmPayments(){
        ...
        let data={};
        data.src = selectedLists();
        data.remarks = $('#common-remarks').val();
        data.inputAmount = $('#total-amount').val();

        $.ajax({
            type: "POST",
            url: "payment/bulk-update-transit-topay-payment",
            data: data,
            dataType: "json",
            success: function (response) {
                loading_overlay.update({

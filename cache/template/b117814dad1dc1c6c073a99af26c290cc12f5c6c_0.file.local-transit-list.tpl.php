<?php
/* Smarty version 3.1.34-dev-7, created on 2024-06-24 19:04:37
  from 'E:\xampp\htdocs\cargo\application\views\site\cargo\local-transit-list.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_667975edb119e3_50777540',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'b117814dad1dc1c6c073a99af26c290cc12f5c6c' => 
    array (
      0 => 'E:\\xampp\\htdocs\\cargo\\application\\views\\site\\cargo\\local-transit-list.tpl',
      1 => 1719203913,
      2 => 'file',
    ),
  ),
...
function content_667975edb119e3_50777540 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->smarty->ext->_tplFunction->registerTplFunctions($_smarty_tpl, array (
  'ogplList' => 
  array (
    'compiled_filepath' => 'E:\\xampp\\htdocs\\cargo\\cache\\template\\b117814dad1dc1c6c073a99af26c290cc12f5c6c_0.file.local-transit-list.tpl.php',
    'uid' => 'b117814dad1dc1c6c073a99af26c290cc12f5c6c',
    'call_name' => 'smarty_template_function_ogplList_1428173378667975ed9526b4_56154737',
  ),
));
...
<div class="tab-content" id="ogpl-trip-list">
    ...
    <div id="intransit_pane" class="tab-pane fade"><?php $_smarty_tpl->smarty->ext->_tplFunction->callTemplateFunction($_smarty_tpl, 'ogplList', array('data'=>$_smarty_tpl->tpl_vars['tabs']->value['DISPATCH']), true);?>
</div>
...
/assets/img/loaders/20.gif' /></div>";
    ...
    function loadTransitFuelExpense() {
        ...
        $.ajax({
            type: 'POST',
            dataType: 'html',
            url: base_url + 'cargo/local-transit-fuel-expense',
            data: data,
            success: function(res) {
                $('#fuel_tab').html(res);
            }
    ...
    function loadTransitIncomeExpense(vehiclecode) {
        ...
        $.ajax({
            type: 'POST',
            dataType: 'html',
            url: base_url + 'cargo/local-transit-income-expense',
            data: data,
            success: function(res) {
...
>
<?php }
/* smarty_template_function_ogplList_1428173378667975ed9526b4_56154737 */
if (!function_exists('smarty_template_function_ogplList_1428173378667975ed9526b4_56154737')) {
function smarty_template_function_ogplList_1428173378667975ed9526b4_56154737(Smarty_Internal_Template $_smarty_tpl,$params) {
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
        ...
        <?php $_smarty_tpl->_assignInScope('outForDelivery', in_array('OUT-FR-DLRY',$_smarty_tpl->tpl_vars['row']->value->activity));?>
        <?php $_smarty_tpl->_assignInScope('isEmptyLoad', in_array('EMP-LOAD',$_smarty_tpl->tpl_vars['row']->value->activity));?>
        <?php $_smarty_tpl->_assignInScope('orgin_startTrip', in_array('ORGN-START-TRIP',$_smarty_tpl->tpl_vars['row']->value->activity));?>
...
" >
 ...
 Next Day
                        ...
                        <h5><?php echo (($tmp = @$_smarty_tpl->tpl_vars['row']->value->fromOrganization->name)===null||$tmp==='' ? $_smarty_tpl->tpl_vars['row']->value->fromStation->name : $tmp);?>
 <img src="assets/img/ogpl/r.png" width="24px"> <?php echo (($tmp = @$_smarty_tpl->tpl_vars['row']->value->toOrganization->name)===null||$tmp==='' ? $_smarty_tpl->tpl_vars['row']->value->toStation->name : $tmp);?>
</h5>
                        <b class="h4 bold"><?php echo $_smarty_tpl->tpl_vars['row']->value->aliasCode;?>
</b>
                        <?php if (count($_smarty_tpl->tpl_vars['row']->value->viaOrganizations) > 0) {?>
                            &nbsp;<a href="javascript:;" class="ogpl-via mnu_border" title="via branches" data-toggle="popover" data-trigger="hover" data-html="true" data-content="
                            <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['row']->value->viaOrganizations, 'via', false, 'i', 'v', array (
));
if ($_from !== null) {
...
&back=ogpl" <?php if ($_smarty_tpl->tpl_vars['isEmptyLoad']->value) {?>onclick="alertEmptyLoad()"<?php }?>> <i class="fa fa-pencil"></i> Edit</a>&emsp;
 ...
 "><i class="fa fa-info-circle"></i></a>
            ...
            <ul class="transit-tabs">
                ...
                <?php $_smarty_tpl->_assignInScope('is_transit_branch', in_array($_smarty_tpl->tpl_vars['login_branch']->value,array_column($_smarty_tpl->tpl_vars['row']->value->transitOrganizations,'code')));?>
...
" title="Unload" target="_blank">Deliver</a></li>
                    ...
                    <?php if (!$_smarty_tpl->tpl_vars['isEmptyLoad']->value) {?>
                        <li class="transit-tab b_l"><a class="tab-link" href="#cargo/local-transit-chart-details?transitCode=<?php echo $_smarty_tpl->tpl_vars['row']->value->code;?>
&date=<?php echo $_smarty_tpl->tpl_vars['row']->value->tripDate;?>
" title="View Chart" target="_blank">View Chart <i class="fa fa-arrow-right"></i></a></li>
                    ...
                    <?php if ($_smarty_tpl->tpl_vars['cargo_setting']->value->ogplModelCode == 'VER3') {?>
                        <?php if ($_smarty_tpl->tpl_vars['cargo_setting']->value->transitOdometerModelCode == 'RTEBSD') {?> 
                            <?php if ($_smarty_tpl->tpl_vars['row']->value->fromOrganization->code != $_smarty_tpl->tpl_vars['login_branch']->value) {?>
                               <li class=""><a class="btn btn-info view-chart-btn" href="#cargo/local-transit-unload-lr?transitCode=<?php echo $_smarty_tpl->tpl_vars['row']->value->code;?>
&date=<?php echo $_smarty_tpl->tpl_vars['row']->value->tripDate;?>
&vehicleCode=<?php echo $_smarty_tpl->tpl_vars['row']->value->busVehicle->code;?>
...
')<?php } else { ?>acceptUnloading();<?php }?>" title="Unload Transit" target="_blank">Unload</a></li>
                            <?php }?>
                        <?php } else { ?>
                            <?php if ($_smarty_tpl->tpl_vars['isEmptyLoad']->value && !$_smarty_tpl->tpl_vars['orgin_startTrip']->value) {?>
                                <li class=""><a class="btn btn-info view-chart-btn disabled" href="javascript:void(0);" title="Trip not yet Started">Unload</a></li>
                            <?php } else { ?>
                             <li class=""><a class="btn btn-info view-chart-btn" href="#cargo/local-transit-unload-lr?transitCode=<?php echo $_smarty_tpl->tpl_vars['row']->value->code;?>
&date=<?php echo $_smarty_tpl->tpl_vars['row']->value->tripDate;?>
&vehicleCode=<?php echo $_smarty_tpl->tpl_vars['row']->value->busVehicle->code;?>
...
&back=ogpl" <?php if ($_smarty_tpl->tpl_vars['isEmptyLoad']->value) {?>onclick="alertEmptyLoad()"<?php }?> title="Load Transit" target="_blank">Load</a></li>
                <?php } else { ?>
                                        <?php if ($_smarty_tpl->tpl_vars['outForDelivery']->value && ($_smarty_tpl->tpl_vars['is_transit_branch']->value && $_smarty_tpl->tpl_vars['row']->value->transitDetailsType->code == "OTFD")) {?>
                        <li class=""><a class="btn btn-success view-chart-btn " href="#cargo/out-for-delivery-unload-lr?transitCode=<?php echo $_smarty_tpl->tpl_vars['row']->value->code;?>
&date=<?php echo $_smarty_tpl->tpl_vars['row']->value->tripDate;?>
&vehicleCode=<?php echo $_smarty_tpl->tpl_vars['row']->value->busVehicle->code;?>
&transitType=<?php echo $_smarty_tpl->tpl_vars['transittypeout']->value;?>
" title="Unload" target="_blank">Deliver</a></li>
                    <?php }?>
                    <?php if (!$_smarty_tpl->tpl_vars['isEmptyLoad']->value) {?>
                        <li class=""><a class="btn btn-primary view-chart-btn" href="#cargo/local-transit-chart-details?transitCode=<?php echo $_smarty_tpl->tpl_vars['row']->value->code;?>
&date=<?php echo $_smarty_tpl->tpl_vars['row']->value->tripDate;?>

<?php
/* Smarty version 3.1.34-dev-7, created on 2024-05-31 16:46:56
  from 'E:\xampp\htdocs\cargo\application\views\site\cargo\branch-stock-report.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_6659b1a80a6048_93035098',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '5bb6cfb3f62e136ad32feca9f332ca291095a06f' => 
    array (
      0 => 'E:\\xampp\\htdocs\\cargo\\application\\views\\site\\cargo\\branch-stock-report.tpl',
      1 => 1716451514,
      2 => 'file',
    ),
  ),
...
function content_6659b1a80a6048_93035098 (Smarty_Internal_Template $_smarty_tpl) {
?><div class="brand_top">
                                                        ...
                                                        <div class="form-group col-md-2">
                                                            ...
                                                            <div class="input-group col-md-12">
                                                                <select id="stock_rpt_cargo_status" name="cargoStatusCode" class="form-control">
                                                                    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['branch_stock_status']->value, 'code');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['code']->value) {
?>
                                                                        <option value="<?php echo $_smarty_tpl->tpl_vars['code']->value;?>
"><?php echo lang(('branch_stock_status_').($_smarty_tpl->tpl_vars['code']->value));?>
</option>
                                                                    <?php
}
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                                        ...
                                                        <?php if ($_smarty_tpl->tpl_vars['action_rights']->value['BSR-ALL-BRNC'] > 0 || $_smarty_tpl->tpl_vars['action_rights']->value['BSR-ALL-STION'] > 0) {?>
                                                        </div>
                                                        <div class="row">
                                                        <?php }?>
                                                        <?php if ($_smarty_tpl->tpl_vars['action_rights']->value['BSR-ALL-STION'] > 0) {?>
                                                            <div class="form-group col-md-2">
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                                        ...
                                                        <?php }?>
                                                        <?php if ($_smarty_tpl->tpl_vars['action_rights']->value['BSR-ALL-BRNC'] > 0) {?>
                                                            <div class="form-group col-md-2">
...
<?php echo '<script'; ?>
>
    var branchList = <?php echo json_encode($_smarty_tpl->tpl_vars['branches']->value);?>
;

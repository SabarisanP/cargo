<?php
/* Smarty version 3.1.34-dev-7, created on 2024-05-28 15:17:40
  from 'E:\xampp\htdocs\cargo\application\views\site\cargo\invoice.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_6655a83c2a1ea3_78622351',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'd0d8577011f22cc33dbf253f2204e687cf5450fe' => 
    array (
      0 => 'E:\\xampp\\htdocs\\cargo\\application\\views\\site\\cargo\\invoice.tpl',
      1 => 1716451514,
      2 => 'file',
    ),
  ),
...
function content_6655a83c2a1ea3_78622351 (Smarty_Internal_Template $_smarty_tpl) {
                                                    ...
                                                    <div class="row">
                                                         <div class="form-group col-md-3">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="text" name="fromDate" class="form-control sdate" id="paid_date_range" readonly placeholder="Today" value="<?php echo implode(' | ',array_filter(array(smarty_modifier_date_format($_smarty_tpl->tpl_vars['ffromDate']->value,'%d-%m-%Y'),smarty_modifier_date_format($_smarty_tpl->tpl_vars['ftoDate']->value,'%d-%m-%Y'))));?>
">
                                                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                            </div>
                                                        </div>
                                                        <div class="form-group col-md-2">
                                                            <label for="paid_vendor_code"><?php echo lang('vendor');?>
</label>
        ...
        <?php if ($_smarty_tpl->tpl_vars['cargo_setting']->value->userAccountModel->code == 'TXRT') {?>
            <div class="col-lg-4">
                ...
                <select class="form-control" id="discount_type">
                    ...
                    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['category_contacts']->value, 'category', false, 'k');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['k']->value => $_smarty_tpl->tpl_vars['category']->value) {
?>
                        <?php if (in_array('INVADJ',$_smarty_tpl->tpl_vars['category']->value->tag)) {?>
                            <optgroup label="<?php echo $_smarty_tpl->tpl_vars['category']->value->name;?>
">
                                <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['category']->value->contacts, 'row');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['row']->value) {
?>
                                    <option value="<?php echo $_smarty_tpl->tpl_vars['row']->value->code;?>
        ...
        <table class="table table-bordered hide" id="paid-info-table">
            <thead>
                <tr class="bold hover-background">
                    <th align="center">Transaction Date</th>
                    <th align="center">Transaction Mode</th>
                    <th align="center"><?php echo lang('vendor');?>
</th>
                    <th align="center" width="15%">Remarks</th>
                    <th align="center">Received Date</th>
                    <th align="center">Paid Amt (A)</th>

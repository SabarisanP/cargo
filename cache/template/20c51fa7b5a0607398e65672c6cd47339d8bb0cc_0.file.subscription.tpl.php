<?php
/* Smarty version 3.1.34-dev-7, created on 2024-05-30 16:15:11
  from 'E:\xampp\htdocs\cargo\application\views\site\admin\subscription.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_665858b733cc16_37036303',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '20c51fa7b5a0607398e65672c6cd47339d8bb0cc' => 
    array (
      0 => 'E:\\xampp\\htdocs\\cargo\\application\\views\\site\\admin\\subscription.tpl',
      1 => 1716451523,
      2 => 'file',
    ),
  ),
...
function content_665858b733cc16_37036303 (Smarty_Internal_Template $_smarty_tpl) {
                            ...
                            <div class="col-lg-12 p_l_n d-flex align-items-center">
                                <div class="col-md-3">
                                    ...
                                    <div class="panel panel-default billing-text-box">
                                        <div class="panel-body">
                                            ...
                                            <div class="">
                                                <p class="billing-count"><?php echo $_smarty_tpl->tpl_vars['billing']->value->gcCount;?>
</p>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="panel panel-default billing-text-box">
                                        <div class="panel-body">
                                            <div class="">
                                                <p class="billing-count"><?php echo $_smarty_tpl->tpl_vars['billing']->value->smsCount;?>
</p>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="panel panel-default billing-text-box">
                                        <div class="panel-body">
                                            <div class="">
                                                <p class="billing-count"><?php echo $_smarty_tpl->tpl_vars['billing']->value->whatsappCount;?>
</p>
                            ...
                            <div class="col-lg-12 p_l_n d-flex align-items-center p_t_50">
                                <div class="col-md-3">
                                    ...
                                    <div class="panel panel-default billing-text-box">
                                        <div class="panel-body">
                                            <div class="">
                                                <p class="billing-count"><?php echo $_smarty_tpl->tpl_vars['billing']->value->ezeebotCount;?>
</p>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="panel panel-default billing-text-box">
                                        <div class="panel-body">
                                            <div class="">
                                                <p class="billing-count"><?php echo $_smarty_tpl->tpl_vars['billing']->value->emailCount;?>
</p>
                                ...
                                <div class="col-md-3" id="subs-ratecard-table-div">
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-body p-0">
                                            <?php if ($_smarty_tpl->tpl_vars['billing']->value->pricingModel == 'LRCNT') {?>
                                                <table class="table">
                                                    <thead>
                                                    ...
                                                    <tbody>
                                                        <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['billing']->value->billingRateCard, 'row');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['row']->value) {
?>
                                                            <tr>
                                                                <td><?php echo $_smarty_tpl->tpl_vars['row']->value->fromValue;?>
 to <?php echo $_smarty_tpl->tpl_vars['row']->value->toValue;?>
</td>
                                                                <td>
                                                                    <?php echo $_smarty_tpl->tpl_vars['row']->value->amount;?>

                                                                    <?php if ($_smarty_tpl->tpl_vars['row']->value->rateCardType->code == "METERED") {?>
                                                                        /GC
                                                                    <?php } else { ?>
                                                                        flat/month
                                                                    <?php }?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                            ...
                                            <?php } elseif ($_smarty_tpl->tpl_vars['billing']->value->pricingModel == 'LRVOL') {?>
                                                <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['billing']->value->billingRateCard, 'row');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['row']->value) {
?>
                                                    <b><?php echo $_smarty_tpl->tpl_vars['row']->value->fromValue;?>
% of Total Transactions per month</b><br><br>
                                                    <?php break 1;?>
                                                <?php
}
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                            ...
                                            <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['billing']->value->billingNotification, 'row');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['row']->value) {
?>
                                                <?php if ($_smarty_tpl->tpl_vars['row']->value->activeFlag == 1) {?>
                                                    <span><b><?php echo $_smarty_tpl->tpl_vars['row']->value->notificationMedium->code;?>
 :</b> <i class="fa fa-inr"></i> <?php echo $_smarty_tpl->tpl_vars['row']->value->amount;?>
 / per <?php echo $_smarty_tpl->tpl_vars['row']->value->notificationMedium->code;?>
</span> <br>
                                                <?php }?>
                                            <?php
}
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                ...
                                <div class="col-md-6">
                                    <div class="panel panel-default col-md-6">
                                        <div class="panel-body p-0">
                                            <p>Total charges till date : <b><i class="fa fa-inr"></i> <?php echo inr_format($_smarty_tpl->tpl_vars['billing']->value->totalAmount);?>
</b> /month </p>
                                        </div>
                                    </div>
                                ...
                                <div class="panel panel-default  ">
                                    <div class="panel-body p-0">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['invoice']->value, 'row', false, 'k');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['k']->value => $_smarty_tpl->tpl_vars['row']->value) {
?>
                                                    <?php if ($_smarty_tpl->tpl_vars['row']->value->status->code == 3 || $_smarty_tpl->tpl_vars['row']->value->status->code == 4 || $_smarty_tpl->tpl_vars['row']->value->status->code == 5) {?>
                                                        <?php $_smarty_tpl->_assignInScope('amount', (($_smarty_tpl->tpl_vars['row']->value->amount+$_smarty_tpl->tpl_vars['row']->value->cgst+$_smarty_tpl->tpl_vars['row']->value->sgst+$_smarty_tpl->tpl_vars['row']->value->igst)+($_smarty_tpl->tpl_vars['row']->value->adjustment)));?>
                                                        <?php $_smarty_tpl->_assignInScope('due', $_smarty_tpl->tpl_vars['row']->value->balanceDue);?>
                                                        <tr>                                                            
                                                            <td><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['row']->value->invoiceDate,"d-m-Y");?>
</td>
                                                            <td><?php echo $_smarty_tpl->tpl_vars['row']->value->invoiceMonth;?>
</td>
                                                            <td><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['row']->value->dueDate,"d-m-Y");?>
</td>
                                                            <td align="center"><span class="<?php echo $_smarty_tpl->tpl_vars['invoice_status']->value[$_smarty_tpl->tpl_vars['row']->value->status->code]['bg_class'];?>
"><?php echo $_smarty_tpl->tpl_vars['invoice_status']->value[$_smarty_tpl->tpl_vars['row']->value->status->code]['name'];?>
</span></td>
                                                            <?php if ($_smarty_tpl->tpl_vars['row']->value->status->code != 5) {?>
                                                                <td align="right"><?php echo inr_format($_smarty_tpl->tpl_vars['amount']->value);?>
</td>
                                                                <td align="right"><?php echo inr_format($_smarty_tpl->tpl_vars['due']->value);?>
</td>
                                                            <?php } else { ?>
                                                                <td align="right">-</td>
                                                                <td align="right">-</td>
                                                            ...
                                                            <td align="left">   
                                                                <?php if ($_smarty_tpl->tpl_vars['row']->value->status->code != 5) {?>
                                                                <a href="javascript:;" onclick="showPaymentQr(<?php echo $_smarty_tpl->tpl_vars['row']->value->code;?>
, '<?php echo inr_format($_smarty_tpl->tpl_vars['due']->value);?>
')" class="btn btn-primary btm-sm" ><i class="fa fa-money" aria-hidden="true"></i>Pay Now</a>                                                                    
                                                                &nbsp;
                                                                <?php }?>
                                                                <a href="<?php echo $_smarty_tpl->tpl_vars['vertex_domain']->value;?>
/api/<?php echo $_smarty_tpl->tpl_vars['accountCode']->value;?>
/<?php echo $_smarty_tpl->tpl_vars['accessToken']->value;?>
/invoice/<?php echo $_smarty_tpl->tpl_vars['row']->value->code;?>
/download" class="btn btn-default btm-sm invoice-download"  target="_blank" ><i class="fa fa-download" aria-hidden="true"></i>Download</a>
                                                            </td>
                                                        </tr>

                                                        <?php if ($_smarty_tpl->tpl_vars['row']->value->status->code != 5) {?>
                                                            <?php $_smarty_tpl->_assignInScope('invamount', $_smarty_tpl->tpl_vars['invamount']->value+$_smarty_tpl->tpl_vars['amount']->value);?>
                                                            <?php $_smarty_tpl->_assignInScope('invdue', $_smarty_tpl->tpl_vars['invdue']->value+$_smarty_tpl->tpl_vars['due']->value);?>
                                                        <?php }?>
                                                    <?php }?>    
                                                <?php
}
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                                <tr>
                                                    ...
                                                    <td align="right"><?php echo inr_format($_smarty_tpl->tpl_vars['invamount']->value);?>
</td>
                                                    <td align="right"><?php echo inr_format($_smarty_tpl->tpl_vars['invdue']->value);?>
</td>
                                                    <td align="left">
                                                        <a href="javascript:;" onclick="showPaymentQr('ALL', '<?php echo inr_format($_smarty_tpl->tpl_vars['invdue']->value);?>
')" class="btn btn-primary btm-sm" ><i class="fa fa-money" aria-hidden="true"></i>Pay Now</a>
                                                    </td>
                                                </tr>    
                                            </tbody>
...
<?php echo '<script'; ?>
>
    var billing = <?php echo json_encode($_smarty_tpl->tpl_vars['billing']->value);?>
;

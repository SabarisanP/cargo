<?php
/* Smarty version 3.1.34-dev-7, created on 2024-06-14 12:50:38
  from 'E:\xampp\htdocs\cargo\application\views\site\cargo\find-bookings.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_666bef462cc2b3_65440138',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '0a203cbdd998f9f76cced400e396c1c3e3db4664' => 
    array (
      0 => 'E:\\xampp\\htdocs\\cargo\\application\\views\\site\\cargo\\find-bookings.tpl',
      1 => 1716451514,
      2 => 'file',
    ),
  ),
...
function content_666bef462cc2b3_65440138 (Smarty_Internal_Template $_smarty_tpl) {
?><div class="brand_top">
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                                    ...
                                                    <div class="row">                                                      
                                                        ...
                                                        <div class="form-group col-md-2">
                                                            ...
                                                            <div class="input-group col-md-12">
                                                                <input type="text" class="form-control" id="fromMobileNumber" name="fromMobileNumber" placeholder="<?php echo lang('booking_sender_term');?>
 Mobile" value="" maxlength="10"/>     
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-2">
                                                            ...
                                                            <div class="input-group col-md-12">
                                                                <input type="text" class="form-control" id="toMobileNumber" name="toMobileNumber" placeholder="<?php echo lang('booking_receiver_term');?>
 Mobile" value="" maxlength="10"/>     
                                                            </div>
                                                        </div> 

                                                        <div class="form-group col-md-2">
                                                            <label  for="trns_rpt_date_to"><?php echo lang('cargo_code_term');?>
</label>
                                                            <div class="input-group col-md-12">
                                                                <input type="text" class="form-control" id="cargoCode" name="cargoCode" placeholder="<?php echo lang('cargo_code_term');?>
...
?> 
                                                                        <option value="<?php echo $_smarty_tpl->tpl_vars['vendor_usr']->value->code;?>

<?php
/* Smarty version 3.1.34-dev-7, created on 2024-06-04 16:55:57
  from 'E:\xampp\htdocs\cargo\application\views\site\cargo\add-ogplv2.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_665ef9c5cf55d0_94826339',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '21324af914346403c4270ad345bacbb45046e37c' => 
    array (
      0 => 'E:\\xampp\\htdocs\\cargo\\application\\views\\site\\cargo\\add-ogplv2.tpl',
      1 => 1716980854,
      2 => 'file',
    ),
  ),
...
function content_665ef9c5cf55d0_94826339 (Smarty_Internal_Template $_smarty_tpl) {
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default" id="ogpl-search-container">
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-md-2 <?php if ($_REQUEST['transitCode']) {?>hide<?php }?>">
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                        ...
                                        <div class="form-group col-md-2 <?php if (!$_REQUEST['transitCode'] || count($_smarty_tpl->tpl_vars['ownershipTypes']->value) > 1) {?>p_t_30<?php }?>">
                                            <?php if ($_REQUEST['transitCode'] || count($_smarty_tpl->tpl_vars['ownershipTypes']->value) < 1) {?>
                                                <label for="">&nbsp;</label>
                                            <?php }?>
                                            <div class="input-group">
                                                <?php if ($_smarty_tpl->tpl_vars['cargo_setting']->value->ogplModelCode == 'VER2') {?>
                            ...
                            <div id="add-ogpl-container" <?php if ($_smarty_tpl->tpl_vars['cargo_setting']->value->ogplModelCode == 'VER2') {?>style="display: none;"<?php }?>>
                                <br>
                                <div class="row">
                                    <div class="col-md-9">
                                                ...
                                                <form id="add-ogpl-form" onsubmit="return false;">
                                                    <div class="row">
                                                        <div class="form-group col-md-3">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="text" name="toDate" class="form-control sdate" id="ogpl-date" readonly <?php if ($_smarty_tpl->tpl_vars['action_rights']->value['OGPL-PREV-DATE'] != 1) {?>disabled<?php }?> value="<?php echo smarty_modifier_date_format(time(),'d-m-Y');?>
" placeholder="Date">
                                                        ...
                                                        <div class="col-md-5" data-transit-field="TRNT">
                                                            <label for="ogpl-tpl"><?php echo lang('ogpl');?>
 Routes
...
" data-stationcode="<?php echo $_smarty_tpl->tpl_vars['row']->value->station->code;?>
...
foreach ($_from as $_smarty_tpl->tpl_vars['row']->value) {
?>
                                                                                        <?php if ($_smarty_tpl->tpl_vars['row']->value->code == $_smarty_tpl->tpl_vars['login_branch']->value) {?>
                                                                                            <option value="<?php echo $_smarty_tpl->tpl_vars['row']->value->code;?>
" data-stationcode="<?php echo $_smarty_tpl->tpl_vars['row']->value->station->code;?>
" selected="selected"><?php echo $_smarty_tpl->tpl_vars['row']->value->name;?>
</option>
                                                                                        <?php }?>
                                                                                    <?php
}
                                        ...
                                        <div class="panel panel-default">
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 text-right">
                                                    ...
                                                    <?php }?>
                                                    <button class="btn btn-success" type="button" id="proceed-transit-btn" onclick="<?php if ($_smarty_tpl->tpl_vars['action_rights']->value['OGPL-IS-FLEET-FREE'] == 1) {?> validateOGPL(); <?php } else { ?> proceedOGPL(); <?php }?>">Next</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

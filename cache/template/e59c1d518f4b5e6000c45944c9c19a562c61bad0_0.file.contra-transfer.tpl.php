<?php
/* Smarty version 3.1.34-dev-7, created on 2024-06-11 11:28:06
  from 'E:\xampp\htdocs\cargo\application\views\site\payment\contra-transfer.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_6667e76ece01c5_20997907',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e59c1d518f4b5e6000c45944c9c19a562c61bad0' => 
    array (
      0 => 'E:\\xampp\\htdocs\\cargo\\application\\views\\site\\payment\\contra-transfer.tpl',
      1 => 1716451515,
      2 => 'file',
    ),
  ),
...
function content_6667e76ece01c5_20997907 (Smarty_Internal_Template $_smarty_tpl) {
?><div class="brand_top">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-2">
                                                            ...
                                                            <div class="input-group col-md-12">
                                                                <select id="contra-transfer-branch" class="form-control" <?php if ($_smarty_tpl->tpl_vars['action_rights']->value['CONTRA-ALLOW-ALL-BRANCH'] != 1) {?>disabled<?php }?>>
                                                                    <option value="NA">All Branch</option>
                                                                    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['organization']->value, 'row');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['row']->value) {
?>
                                                                        <option value="<?php echo $_smarty_tpl->tpl_vars['row']->value->code;?>
" <?php if ($_smarty_tpl->tpl_vars['loggedin_user_org']->value == $_smarty_tpl->tpl_vars['row']->value->code) {?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['row']->value->name;?>
</option>
                                                                    <?php
}
}
...
<div id="add-contra-transfer-dialog"  class="dialog-content-page hide">
    ...
    <div class="row">
        <div class="form-group col-md-4">
            ...
            <input type="text" class="form-control" id="contra-transfer-pay-con" onclick="getVendorContact();" <?php if ($_smarty_tpl->tpl_vars['action_rights']->value['CONTRA-ALLOW-ALL-BRANCH'] != 1) {?>disabled<?php }?>>
        </div>
...
<?php echo '<script'; ?>
 id="contact-select-tpl" type="text/html">
    <div class="row">
        <div class="col-xs-8">
...
<?php echo '<script'; ?>
 id="account-select-tpl" type="text/html">
    <div class="row">
        <div class="col-xs-7">
...
<?php echo '<script'; ?>
>
    var organizationcode = <?php echo json_encode($_smarty_tpl->tpl_vars['loggedin_user_org']->value);?>

    var logged_in_user = <?php echo json_encode($_smarty_tpl->tpl_vars['logged_in_user']->value);?>

    var branchBankData = <?php echo json_encode($_smarty_tpl->tpl_vars['branchBankData']->value);?>
 
    var user_code = <?php echo json_encode($_smarty_tpl->tpl_vars['user_code']->value);?>
;

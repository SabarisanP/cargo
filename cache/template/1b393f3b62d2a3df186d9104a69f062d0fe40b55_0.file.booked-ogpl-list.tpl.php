<?php
/* Smarty version 3.1.34-dev-7, created on 2024-05-28 15:29:44
  from 'E:\xampp\htdocs\cargo\application\views\site\cargo\booked-ogpl-list.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_6655ab1068b4c7_21245386',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '1b393f3b62d2a3df186d9104a69f062d0fe40b55' => 
    array (
      0 => 'E:\\xampp\\htdocs\\cargo\\application\\views\\site\\cargo\\booked-ogpl-list.tpl',
      1 => 1716451514,
      2 => 'file',
    ),
  ),
...
function content_6655ab1068b4c7_21245386 (Smarty_Internal_Template $_smarty_tpl) {
if ($_REQUEST['code'] != '') {?>
...
<div class="tab-content">
 ...
 To Station 
                        ...
                        <?php }?>
                        <div class="form-group col-md-2">
                            <label  for="ogpl-load-cargocode"><?php echo lang('cargo_code_term');?>
</label>
                            <div class="input-group col-md-12">
                                <input type="text" class="form-control" id="ogpl-load-cargocode" name="cargoCode" placeholder="<?php echo lang('cargo_code_term');?>
" value="" style="text-transform:uppercase" />     
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <div class="input-group">
                                ...
                                <button type="button" class="btn btn-success" onclick="ogplLRSearchReport();">Get <?php echo lang('lr');?>
 List</button>&nbsp;
...
<?php echo '<script'; ?>
>
    var allStations = <?php echo json_encode($_smarty_tpl->tpl_vars['stations']->value);?>
;
    var allZone = <?php echo json_encode($_smarty_tpl->tpl_vars['zone']->value);?>
;
    var loadingAllowed = '<?php echo $_REQUEST['loadtype'];?>
';
    var namespace = <?php echo json_encode($_smarty_tpl->tpl_vars['namespace']->value);?>
;
...
;
    ...
    <?php if ($_smarty_tpl->tpl_vars['namespace']->value == 'royalcargo') {?>
    ...
    <?php if ($_smarty_tpl->tpl_vars['action_rights']->value['OGPL-HUB-LOAD'] == 1) {?>
        var stationbranch = <?php echo json_encode($_smarty_tpl->tpl_vars['stationbranch']->value);?>
;
        var branchesOption = [];
        stationMap.forEach(function (val, key) {
            $.each (stationbranch[key] || [], function (i, row) {
                if (!row.code != '<?php echo $_smarty_tpl->tpl_vars['userorgcode']->value;?>
') {
        ...
        $('#ogpl-load-transit-branch')
                .html(new Option('<?php echo $_smarty_tpl->tpl_vars['userorgname']->value;?>
', '<?php echo $_smarty_tpl->tpl_vars['userorgcode']->value;?>
'))
    ...
    function getLoadedOGPL() {
        var data = {};
        data.transitCode = '<?php echo $_REQUEST['code'];?>
';
    ...
    function printLoadingSheet() {
        var data = {};
        data.print = 1;
        data.code = '<?php echo $_REQUEST['code'];?>
';
        data.fromDate = $('#ogpl-load-from').val();
        data.toDate = $('#ogpl-load-to').val();
        data.toStationCode = $('#ogpl-load-org').val();
    ...
    function startOGPLTrip() {
        ...
        data.fromOrganization.code = '<?php echo $_smarty_tpl->tpl_vars['login_branch']->value;?>
';
...
';
    ...
    function endOGPLTrip() {
        ...
        data.transitCargo.code = OGPLFormData.code;
        data.toOrganization = {};
        data.toOrganization.code = '<?php echo $_smarty_tpl->tpl_vars['logged_in_org']->value;?>
';

<?php
/* Smarty version 3.1.34-dev-7, created on 2024-06-15 16:26:49
  from 'E:\xampp\htdocs\cargo\application\views\site\payment\transaction-receipt-print-seenutransport.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_666d7371488cb8_33564983',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '560f5bd51611d14954ab4f48502ea1543c3b47a9' => 
    array (
      0 => 'E:\\xampp\\htdocs\\cargo\\application\\views\\site\\payment\\transaction-receipt-print-seenutransport.tpl',
      1 => 1718447358,
      2 => 'file',
    ),
  ),
...
function content_666d7371488cb8_33564983 (Smarty_Internal_Template $_smarty_tpl) {
...
if ($_smarty_tpl->tpl_vars['SinglrList']->value->additionalAttribute->TRANSACTION_RECEIPT == $_smarty_tpl->tpl_vars['result']->value->code && $_smarty_tpl->tpl_vars['SinglrList']->value->transactionType->code == "MCHC") {?> 
    <?php $_smarty_tpl->_assignInScope('transactionAmount', $_smarty_tpl->tpl_vars['transactionAmount']->value+$_smarty_tpl->tpl_vars['SinglrList']->value->transactionAmount);?>
    <?php $_smarty_tpl->_assignInScope('extraCharges', true);?>
 <?php }?> 
<?php
}
}
...
<table class="border-outline" width="100%" cellspacing="0" cellpadding="0">
    <tr class="bold">
        ...
        <td align="center" width="75%">
            ...
            <p style="font-size: 8px;"><b>Booking Branch : </b> <span style="font-size: 8px;color: #333232;"><?php if (isNotNull($_smarty_tpl->tpl_vars['summary']->value)) {
...
if (isNotNull($_smarty_tpl->tpl_vars['summary']->value[0]->fromOrganization->contact)) {?> ,Ph :<?php echo $_smarty_tpl->tpl_vars['summary']->value[0]->fromOrganization->contact;
            ...
            <p style="font-size: 8px;"><b>Delivery Branch : </b> <span style="font-size: 8px;color: #333232;"><?php if (isNotNull($_smarty_tpl->tpl_vars['summary']->value)) {
...
<table class="bordered" cellpadding="2">
    ...
    <tr>
        <td colspan="4"><b>Invoice No :</b>&nbsp;<?php echo $_smarty_tpl->tpl_vars['result']->value->code;?>
</td>
        <td colspan="4"><b>Invoice Date :</b>&nbsp;<?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['result']->value->transactionDate,"d-m-Y");?>
</td>
    </tr>
    <tr>
        <td colspan="4"><b>GSTIN :</b> <?php echo $_smarty_tpl->tpl_vars['deliveryBranchGstCode']->value->gstin;?>
</td>
        <td colspan="4"></td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="4"><b>Name :</b> <?php echo (($tmp = @$_smarty_tpl->tpl_vars['ReceiptLr']->value[0]->toCustomer->name)===null||$tmp==='' ? '-' : $tmp);?>
</td>
        <td colspan="4">
            <b>Name :</b> <?php echo (($tmp = @$_smarty_tpl->tpl_vars['ReceiptLr']->value[0]->toCustomer->name)===null||$tmp==='' ? '-' : $tmp);?>

        </td>
    </tr>
    <tr>
        <td colspan="4"><b>Address :</b> <?php echo $_smarty_tpl->tpl_vars['ReceiptLr']->value[0]->toCustomerAddress->address1;?>
...
,<?php echo $_smarty_tpl->tpl_vars['ReceiptLr']->value[0]->toCustomerAddress->pincode;?>
    ...
    <tr>
        <td colspan="4"><b>GSTIN :</b> <?php echo (($tmp = @$_smarty_tpl->tpl_vars['ReceiptLr']->value[0]->toCustomerGST)===null||$tmp==='' ? '-' : $tmp);?>
</td>
        <td colspan="4"><b>GSTIN :</b> <?php echo (($tmp = @$_smarty_tpl->tpl_vars['ReceiptLr']->value[0]->toCustomerGST)===null||$tmp==='' ? '-' : $tmp);?>
</td>
    </tr>
    <tr>
        <td class="bold"><b>State</b></td>
        <td><?php echo (($tmp = @$_smarty_tpl->tpl_vars['gst_state']->value[substr($_smarty_tpl->tpl_vars['ReceiptLr']->value[0]->toCustomerGST,0,2)])===null||$tmp==='' ? '-' : $tmp);?>
</td>
        <td class="bold"><b>Code</b></td>
        <td><?php echo (($tmp = @substr($_smarty_tpl->tpl_vars['ReceiptLr']->value[0]->toCustomerGST,0,2))===null||$tmp==='' ? '-' : $tmp);?>
</td>
        <td class="bold"><b>State</b></td>
        <td><?php echo (($tmp = @$_smarty_tpl->tpl_vars['gst_state']->value[substr($_smarty_tpl->tpl_vars['ReceiptLr']->value[0]->toCustomerGST,0,2)])===null||$tmp==='' ? '-' : $tmp);?>
</td>
...
<table class="bordered" cellpadding="2" id="tab-2" width="100%">
    <thead>
        <tr style="font-weight:bold; background-color: #E8E8E8;">
            ...
            <th align="center" width="16%" rowspan="2" nowrap><?php echo lang('lr');?>
 No</th>
            <th align="center" width="12%" rowspan="2">LR Date</th>
            <th align="center" width="12%" rowspan="2"><?php echo lang('booking_from_term');?>
</th>
            <th align="center" width="12%" rowspan="2"><?php echo lang('booking_to_label');?>
</th>
    ...
    <?php $_smarty_tpl->_assignInScope('total_lr_amt', 0);?>
    <?php $_smarty_tpl->_assignInScope('total_lr', 0);?>
    <?php $_smarty_tpl->_assignInScope('k', 0);?>
    <?php $_smarty_tpl->_assignInScope('lr_net_amount', $_smarty_tpl->tpl_vars['lr_net_amount']->value);?>
    <?php $_smarty_tpl->_assignInScope('total_amts', 0);?>
...
?>
        <?php $_smarty_tpl->_assignInScope('rounf_off_val', 0);?>
        <?php
...
?>
            <?php if ($_smarty_tpl->tpl_vars['keys']->value->addonsType->code == "RNDF") {?>
                <?php $_smarty_tpl->_assignInScope('rounf_off_val', $_smarty_tpl->tpl_vars['rounf_off_val']->value+$_smarty_tpl->tpl_vars['keys']->value->value);?>
                <?php break 1;?>
            <?php }?>
        <?php
}
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
        <?php $_smarty_tpl->_assignInScope('lr_net_amount', $_smarty_tpl->tpl_vars['lr_net_amount']->value+($_smarty_tpl->tpl_vars['row']->value->totalAmount+$_smarty_tpl->tpl_vars['row']->value->totalHandlingAmount+$_smarty_tpl->tpl_vars['row']->value->totalUnloadHandlingAmount+$_smarty_tpl->tpl_vars['row']->value->docketCharge+$_smarty_tpl->tpl_vars['row']->value->passCharge+$_smarty_tpl->tpl_vars['row']->value->hamaliCharge+$_smarty_tpl->tpl_vars['row']->value->pickupHandlingAmount+$_smarty_tpl->tpl_vars['row']->value->deliveryHandlingAmount+$_smarty_tpl->tpl_vars['other_ch_amount']->value));?>
        <?php $_smarty_tpl->_assignInScope('total_amts', $_smarty_tpl->tpl_vars['total_amts']->value+($_smarty_tpl->tpl_vars['row']->value->paymentAmount));?>
        <tr>
            <th align="center" width="8%"><?php echo $_smarty_tpl->tpl_vars['k']->value+1;?>
</th>
            <td align="left" width="16%" nowrap><?php echo $_smarty_tpl->tpl_vars['row']->value->code;?>
</td>
            <td align="left" width="12%"><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['row']->value->bookedAt,"d-m-Y");?>
</td>
            <td align="left" width="12%"><?php echo $_smarty_tpl->tpl_vars['row']->value->fromOrganization->shortCode;?>
</td>
            <td align="left" width="12%"><?php echo $_smarty_tpl->tpl_vars['row']->value->toOrganization->shortCode;?>
</td>
            <td align="center" width="16%"><?php echo $_smarty_tpl->tpl_vars['cargo_payment_status']->value[$_smarty_tpl->tpl_vars['row']->value->paymentType->code];?>
</td>
            <td align="right" width="12%"><?php echo amountToRupeesPaise(($_smarty_tpl->tpl_vars['row']->value->deliveryHandlingAmount+$_smarty_tpl->tpl_vars['row']->value->pickupHandlingAmount+$_smarty_tpl->tpl_vars['row']->value->hamaliCharge+$_smarty_tpl->tpl_vars['row']->value->passCharge+$_smarty_tpl->tpl_vars['row']->value->docketCharge+$_smarty_tpl->tpl_vars['row']->value->totalAmount+$_smarty_tpl->tpl_vars['row']->value->totalHandlingAmount+$_smarty_tpl->tpl_vars['row']->value->totalUnloadHandlingAmount),'RUPEES');?>
</td>
            <td align="right" width="12%"><?php echo amountToRupeesPaise(($_smarty_tpl->tpl_vars['row']->value->deliveryHandlingAmount+$_smarty_tpl->tpl_vars['row']->value->pickupHandlingAmount+$_smarty_tpl->tpl_vars['row']->value->hamaliCharge+$_smarty_tpl->tpl_vars['row']->value->passCharge+$_smarty_tpl->tpl_vars['row']->value->docketCharge+$_smarty_tpl->tpl_vars['row']->value->totalAmount+$_smarty_tpl->tpl_vars['row']->value->totalHandlingAmount+$_smarty_tpl->tpl_vars['row']->value->totalUnloadHandlingAmount),'RUPEES');?>
</td>
        </tr>
        <?php $_smarty_tpl->_assignInScope('total_lr_amt', $_smarty_tpl->tpl_vars['total_lr_amt']->value+($_smarty_tpl->tpl_vars['row']->value->deliveryHandlingAmount+$_smarty_tpl->tpl_vars['row']->value->pickupHandlingAmount+$_smarty_tpl->tpl_vars['row']->value->hamaliCharge+$_smarty_tpl->tpl_vars['row']->value->passCharge+$_smarty_tpl->tpl_vars['row']->value->docketCharge+$_smarty_tpl->tpl_vars['row']->value->totalAmount+$_smarty_tpl->tpl_vars['row']->value->totalHandlingAmount+$_smarty_tpl->tpl_vars['row']->value->totalUnloadHandlingAmount));?>
...
<?php $_smarty_tpl->_assignInScope('net_total', $_smarty_tpl->tpl_vars['net_total']->value+($_smarty_tpl->tpl_vars['total_lr_amt']->value+$_smarty_tpl->tpl_vars['result']->value->machineHandlingCharge+$_smarty_tpl->tpl_vars['result']->value->demurrageCharge+$_smarty_tpl->tpl_vars['rounf_off_val']->value));
if (($_smarty_tpl->tpl_vars['result']->value->cargoBookings[0]->paymentType->code == "PAD") && $_smarty_tpl->tpl_vars['extraCharges']->value) {?>
    ...
    <?php $_smarty_tpl->_assignInScope('net_total', (($_smarty_tpl->tpl_vars['net_total']->value+$_smarty_tpl->tpl_vars['transactionAmount']->value)));
}?>
    ...
    <tr>
        <td colspan="5">
            <table style="padding:5px 4px;">
                ...
                <tr>
                    ...
                    <td class="dotted-border-bottom blod"><b><?php echo $_smarty_tpl->tpl_vars['result']->value->cargoBookings[0]->code;?>
</b></td>
                    <td class="bold" align="right">Date :</td>
                    <td class="dotted-border-bottom blod"><b><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['result']->value->cargoBookings[0]->bookedAt,"d-m-Y");?>
</b></td>
                </tr>
                <tr>
                    <td class="bold">No. of Days</td>
                    <td class="dotted-border-bottom">
                        <?php if ($_smarty_tpl->tpl_vars['result']->value->demurrageCharge > 0) {?>
                            10
                        <?php }?>
                    </td>
                    <td class="bold" align="right">Demurrage Charge :</td>
                    <td class="dotted-border-bottom"><?php echo inr_format($_smarty_tpl->tpl_vars['result']->value->demurrageCharge);?>
</td>
                </tr>
                <tr>
                    <td class="bold">Add Other Charges</td>
                                                                    <td class="dotted-border-bottom" colspan="1" align = "center"><?php echo inr_format($_smarty_tpl->tpl_vars['result']->value->machineHandlingCharge);?>
</td>
                    <td class="dotted-border-bottom" colspan="2" align = "left"><b><?php if (($_smarty_tpl->tpl_vars['result']->value->machineHandlingCharge > 0 || $_smarty_tpl->tpl_vars['transactionAmount']->value > 0)) {?>(Machine Handling Charge)<?php }?></b></td>
                                    </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="dotted-border-bottom blod" colspan="3"><b><?php echo inr_format($_smarty_tpl->tpl_vars['result']->value->tdsAmount);?>
</b></td>
                </tr>
                <tr>
                    <td class=" bold">TAXABLE VALUE :</td>
                    <td class=" bold dotted-border-bottom" align="center"> <?php echo inr_format(($_smarty_tpl->tpl_vars['net_total']->value));?>
</td>
                    <td align="right" colspan="2" class="bold">Total</td>
                </tr>
                <?php if ($_smarty_tpl->tpl_vars['deliveryBranchGstCode']->value->state->code == $_smarty_tpl->tpl_vars['Gststate']->value) {?>
                    <tr>
        ...
        <td colspan="2">
            ...
            <table style="padding:5px 5px;" class="bordered">
                <tr class="bold">
                    <td colspan="2" align="center">Amount : <?php echo $_smarty_tpl->tpl_vars['result']->value->cargoBookings[0]->paymentType->code == "PAD" && $_smarty_tpl->tpl_vars['extraCharges']->value ? (amountToRupeesPaise($_smarty_tpl->tpl_vars['transactionAmount']->value,'RUPEES')) : (amountToRupeesPaise($_smarty_tpl->tpl_vars['total_lr_amt']->value,'RUPEES'));?>
</td>
                </tr>
                <tr class="bold">
                ...
                <tr>
                <td align="right"><?php echo $_smarty_tpl->tpl_vars['result']->value->cargoBookings[0]->paymentType->code == "PAD" && $_smarty_tpl->tpl_vars['extraCharges']->value ? (amountToRupeesPaise(0,'RUPEES')) : (amountToRupeesPaise($_smarty_tpl->tpl_vars['total_lr_amt']->value,'RUPEES'));?>
</td>
                <td align="right"><?php echo $_smarty_tpl->tpl_vars['result']->value->cargoBookings[0]->paymentType->code == "PAD" && $_smarty_tpl->tpl_vars['extraCharges']->value ? (amountToRupeesPaise(0,'RUPEES')) : (amountToRupeesPaise(($_smarty_tpl->tpl_vars['result']->value->transactionAmount+$_smarty_tpl->tpl_vars['result']->value->tdsAmount),'PAISE'));?>
</td>
                </tr>
                <tr>
                    <td align="right"><?php echo amountToRupeesPaise($_smarty_tpl->tpl_vars['result']->value->demurrageCharge,'RUPEES');?>
</td>
                    <td align="right"><?php echo amountToRupeesPaise($_smarty_tpl->tpl_vars['result']->value->demurrageCharge,'PAISE');?>
</td>
                </tr>
                <tr>
                                    <td align="right"><?php echo amountToRupeesPaise($_smarty_tpl->tpl_vars['result']->value->machineHandlingCharge,'RUPEES');?>
</td>
                    <td align="right"><?php echo amountToRupeesPaise($_smarty_tpl->tpl_vars['result']->value->machineHandlingCharge,'PAISE');?>
</td>
                                    </tr>
                <tr>
                ...
                <tr>
                    <td align="right"><?php echo amountToRupeesPaise($_smarty_tpl->tpl_vars['result']->value->tdsAmount,'RUPEES');?>
</td>
                    <td align="right"><?php echo amountToRupeesPaise($_smarty_tpl->tpl_vars['result']->value->tdsAmount,'PAISE');?>
</td>
                </tr>
                <tr>
                <?php if (($_smarty_tpl->tpl_vars['result']->value->cargoBookings[0]->paymentType->code == "PAD" && $_smarty_tpl->tpl_vars['extraCharges']->value)) {?>
                    <td align="right" class="bold" style="font-size: 9px;"><?php echo $_smarty_tpl->tpl_vars['result']->value->cargoBookings[0]->paymentType->code == "PAD" && $_smarty_tpl->tpl_vars['extraCharges']->value ? (amountToRupeesPaise(($_smarty_tpl->tpl_vars['net_total']->value-$_smarty_tpl->tpl_vars['result']->value->tdsAmount),'RUPEES')) : (amountToRupeesPaise($_smarty_tpl->tpl_vars['net_total']->value,'RUPEES'));?>
</td>
                    <td align="right" class="bold" style="font-size: 9px;"><?php echo $_smarty_tpl->tpl_vars['result']->value->cargoBookings[0]->paymentType->code == "PAD" && $_smarty_tpl->tpl_vars['extraCharges']->value ? (amountToRupeesPaise(($_smarty_tpl->tpl_vars['net_total']->value-$_smarty_tpl->tpl_vars['result']->value->tdsAmount),'PAISE')) : (amountToRupeesPaise($_smarty_tpl->tpl_vars['net_total']->value,'PAISE'));?>
</td> 

                    <?php } else { ?>
                    <td align="right" class="bold" style="font-size: 9px;"><?php echo amountToRupeesPaise(($_smarty_tpl->tpl_vars['total_lr_amt']->value+$_smarty_tpl->tpl_vars['result']->value->machineHandlingCharge+$_smarty_tpl->tpl_vars['result']->value->demurrageCharge+$_smarty_tpl->tpl_vars['rounf_off_val']->value-$_smarty_tpl->tpl_vars['result']->value->tdsAmount),'RUPEES');?>
</td>
                ...
                <?php if ($_smarty_tpl->tpl_vars['deliveryBranchGstCode']->value->state->code == $_smarty_tpl->tpl_vars['Gststate']->value) {?>
                    <tr>
                        <td align="center" class="bold" style="font-size: 9px;" colspan="2"><b><?php echo $_smarty_tpl->tpl_vars['net_total']->value*2.5/number_format(100,2);?>
</b></td>
                    </tr>
                    <tr>
                        <td align="center" class="bold" style="font-size: 9px;" colspan="2"><b><?php echo $_smarty_tpl->tpl_vars['net_total']->value*2.5/number_format(100,2);?>
                ...
                <?php } else { ?>
                    <tr>
                        <td align="center" colspan="2"><b><?php echo $_smarty_tpl->tpl_vars['net_total']->value*5/number_format(100,2);?>
</b></td>
                    </tr>
                <?php }?>
            </table>
...
<br />
<br />
<table><tr><td width="70%"><table style="padding:5px 4px;"><tr><td colspan="3">Receipt No :&nbsp;<b><?php echo $_smarty_tpl->tpl_vars['result']->value->cargoBookings[0]->additionalAttribute->VOUCHER_NUMBER;?>

<?php
/* Smarty version 3.1.34-dev-7, created on 2024-06-27 19:28:01
  from 'E:\xampp\htdocs\cargo\application\views\site\cargo\add-ogplv3.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_667d6fe98241d0_37355268',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '075f207ce8f99e1f8452a0de2819bd6c598be1eb' => 
    array (
      0 => 'E:\\xampp\\htdocs\\cargo\\application\\views\\site\\cargo\\add-ogplv3.tpl',
      1 => 1719486093,
      2 => 'file',
    ),
  ),
...
function content_667d6fe98241d0_37355268 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'E:\\xampp\\htdocs\\cargo\\application\\third_party\\Smarty\\plugins\\modifier.date_format.php','function'=>'smarty_modifier_date_format',),));
?>
<div class="brand_top">
    <h3>
        <?php if ($_REQUEST['transitCode'] == '') {?>Add Transit<?php } else { ?>Edit Transit<?php }?>
    </h3>
    <span class="align-right">
        <?php if ($_REQUEST['transitCode'] == '') {?>
            <a href="#cargo/<?php echo (($tmp = @$_REQUEST['back'])===null||$tmp==='' ? 'ogpl' : $tmp);?>
" class="btn btn-success  btn-sm"><i class="fa fa-arrow-left"></i> Back</a>
        <?php } else { ?>
            <a href="#cargo/<?php echo (($tmp = @$_REQUEST['back'])===null||$tmp==='' ? 'ogpl' : $tmp);?>
?fill=1" class="btn btn-success  btn-sm"><i class="fa fa-arrow-left"></i> Back</a>
        <?php }?>
    </span>
</div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="pb10">
                                                <div class="btn-group btn-group-days" id="transit-type" data-toggle="buttons">
                                                    <?php if ($_smarty_tpl->tpl_vars['cargo_setting']->value->transitMode[1] && $_smarty_tpl->tpl_vars['action_rights']->value['TRANSIT-DIRECT-LOAD'] == 1) {?>
                                                    <label class="btn btn-success chk-btn" title="Direct Load" <?php if ($_REQUEST['transitCode'] == "TRNT") {?>disabled<?php }?>>
                                                            <input type="checkbox" name="transit-type" value="TRNT" <?php if ($_REQUEST['transitCode'] == "TRNT") {?>disabled<?php }?>>Direct Load
                                                        </label>
                                                    <?php }?>
                                                    
                                                    <?php if ($_smarty_tpl->tpl_vars['cargo_setting']->value->transitMode[2] && $_smarty_tpl->tpl_vars['action_rights']->value['TRANSIT-LINK-LOAD'] == 1) {?>
                                                        <label class="btn btn-success chk-btn" title="Link Load" <?php if ($_REQUEST['transitCode'] == "HBTRNT") {?>disabled<?php }?>>
                                                            <input type="checkbox" name="transit-type" value="HBTRNT" <?php if ($_REQUEST['transitCode'] == "HBTRNT") {?>disabled<?php }?>><?php echo lang('hub');?>
 Load
                                                        </label>
                                                    <?php }?>
                                                    
                                                    <?php if ($_smarty_tpl->tpl_vars['cargo_setting']->value->transitMode[3] && $_smarty_tpl->tpl_vars['action_rights']->value['TRANSIT-LOCAL-LOAD'] == 1) {?>
                                                        <label class="btn btn-success chk-btn" title="Local Transit" <?php if ($_REQUEST['transitCode'] == "INTRNT") {?>disabled<?php }?>>
                                                            <input type="checkbox" name="transit-type" value="INTRNT" <?php if ($_REQUEST['transitCode'] == "INTRNT") {?>disabled<?php }?>>Local Transit
                                                        </label>
                                                    <?php }?>
                                                    <?php if ($_smarty_tpl->tpl_vars['cargo_setting']->value->transitMode[4] && $_smarty_tpl->tpl_vars['action_rights']->value['TRANSIT-OUT-FOR-DELIVERY'] == 1) {?>
                                                        <label class="btn btn-success chk-btn" title="Out for delivery" <?php if ($_REQUEST['transitCode'] == "OTFD") {?>disabled<?php }?>>
                                                            <input type="checkbox" name="transit-type" value="OTFD" <?php if ($_REQUEST['transitCode'] == "OTFD") {?>disabled<?php }?>>Out For Delivery
                                                        </label>
                                                    <?php }?>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-3 bx-grey">
                                            ...
                                            <div class="pull-right pb10 <?php if ($_REQUEST['transitCode'] || count($_smarty_tpl->tpl_vars['ownershipTypes']->value) <= 1) {?>hide<?php }?>" id="ogpl-search-owner">
                                                <div class="btn-group btn-group-days" data-toggle="buttons">
                                                    ...
                                                    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['ownershipTypes']->value, 'name', false, 'code');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['code']->value => $_smarty_tpl->tpl_vars['name']->value) {
?>
                                                        <label class="btn btn-success btn-xs chk-btn" title="<?php echo $_smarty_tpl->tpl_vars['name']->value;?>
">
                                                            <input type="radio" name="ogpl-search-owner" value="<?php echo $_smarty_tpl->tpl_vars['code']->value;?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                            ...
                                            <div class="row">
                                                ...
                                                <?php if ($_smarty_tpl->tpl_vars['action_rights']->value['ADD-NEW-VEHICLE']) {?>
                                                    <div class="col-sm-5">
                                                        <a href="javascript:;" class="m-t-5 bold pull-right <?php if ($_REQUEST['transitCode']) {?>hide<?php }?>" onclick="quickAddNewVehicle()">Add New Vehicle</a>
                                                    </div>
                                                <?php }?>
                                                                                ...
                                                                                <div class="form-group col-md-1 <?php if (!$_REQUEST['transitCode'] || count($_smarty_tpl->tpl_vars['ownershipTypes']->value) > 1) {?>p_t_30<?php }?>">
                                            <?php if ($_REQUEST['transitCode'] || count($_smarty_tpl->tpl_vars['ownershipTypes']->value) < 1) {?>
                                                <label for="">&nbsp;</label>
                                            <?php }?>
                                            <div class="input-group">
                                                <?php if ($_smarty_tpl->tpl_vars['cargo_setting']->value->ogplModelCode == 'VER3') {?>
                                                    <button class="btn btn-success <?php if ($_REQUEST['transitCode'] || count($_smarty_tpl->tpl_vars['ownershipTypes']->value) < 1) {?> m-t-5<?php }?>" type="button" onclick="getOgplList();">Get <?php echo lang('ogpl');?>
</button>&nbsp;
                                                <?php }?>
                                            </div>
                                        </div>
                                            ...
                                            <div class="panel-body">
                                                <form id="add-ogpl-form" onsubmit="return false;">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                            <?php if ($_smarty_tpl->tpl_vars['action_rights']->value == "SAVE-OGPL-TEMPLATE") {?>
                                                            ...
                                                            <?php }?>
                                                                ...
                                                                <input type="text" class="form-control" id="ogpl-name" placeholder="<?php echo lang('ogpl');?>
 Name" maxlength="40">
                                                        ...
                                                        <div class="col-md-5" data-transit-field="TRNT">
                                                            <label for="ogpl-tpl"><?php echo lang('Transit');?>
 Routes
                                                            ...
                                                            <div class="form-group">
                                                                <select id="ogpl-tpl" class="form-control" onchange="setOGPLTemplate(this.value)">
                                                                    ...
                                                                    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['ogpltpl']->value, 'tpl');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['tpl']->value) {
?>
                                                                        <?php if ($_smarty_tpl->tpl_vars['tpl']->value->fromStation->code == $_smarty_tpl->tpl_vars['login_station']->value) {?>
                                                                        <option value="<?php echo $_smarty_tpl->tpl_vars['tpl']->value->code;?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                                     ...
                                                     <div class="row">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="text" name="toDate" class="form-control sdate" id="ogpl-date" readonly <?php if ($_smarty_tpl->tpl_vars['action_rights']->value['OGPL-PREV-DATE'] != 1) {?>disabled<?php }?> value="<?php echo smarty_modifier_date_format(time(),$_smarty_tpl->tpl_vars['ns_date_format']->value);?>
...
" data-stationcode="<?php echo $_smarty_tpl->tpl_vars['station']->value['code'];?>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select id="ogpl-departuretime" class="form-control">
                                                                    ...
                                                                    <?php $_smarty_tpl->_assignInScope('timerange', hours_range(0,86400-1,60*15));?>
                                                                    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['timerange']->value, 'time', false, 'seconds');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['seconds']->value => $_smarty_tpl->tpl_vars['time']->value) {
?>
                                                                        <option value="<?php echo $_smarty_tpl->tpl_vars['seconds']->value/60;?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group" data-transit-field="TRNT">
                                                                <label for="link-load-stations" class="req"><?php echo lang('hub');?>
 Load <a href="javascript:;" class="pull-right" onclick="addLinkLoadZone()">Add <?php echo lang('hub');?>
 Load Zones</a></label>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group hide" data-transit-field="TRNT" id="ogpl-add-link-load-zones-div">
                                                                <label for="link-load-zones"><?php echo lang('hub');?>
 Load Zones</label>
...
?>
                                                                                <?php if ($_smarty_tpl->tpl_vars['row']->value->station->code == $_smarty_tpl->tpl_vars['login_station']->value && $_smarty_tpl->tpl_vars['row']->value->code != $_smarty_tpl->tpl_vars['login_branch']->value && $_smarty_tpl->tpl_vars['row']->value->hubFlag) {?>
                                                                                    <option value="<?php echo $_smarty_tpl->tpl_vars['row']->value->code;?>
"><?php echo $_smarty_tpl->tpl_vars['row']->value->name;?>
</option>
                                                                                <?php }?>
                                    ...
                                    <div id="edit-ogpl-list">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7" style="line-height: 25px;">
                                                ...
                                                <span id="edit-link-load-via-hide"><b><?php echo lang('hub');?>
 Load Via :</b> <span id="edit-link-load-via"></span><br></span>
                                                <span id="edit-link-load-via-zone-hide"><b><?php echo lang('hub');?>
 Load Via Zone :</b> <span id="edit-link-load-via-zone"></span><br></span>
                    ...
                    <?php $_smarty_tpl->_assignInScope('isTransitModel', array());?>
                                            <?php if ($_smarty_tpl->tpl_vars['action_rights']->value['TRANSIT-DIRECT-LOAD'] == 1) {?>
                        <?php $_tmp_array = isset($_smarty_tpl->tpl_vars['isTransitModel']) ? $_smarty_tpl->tpl_vars['isTransitModel']->value : array();
if (!is_array($_tmp_array) || $_tmp_array instanceof ArrayAccess) {
settype($_tmp_array, 'array');
}
$_tmp_array[] = 'TRANSIT-DIRECT-LOAD';
$_smarty_tpl->_assignInScope('isTransitModel', $_tmp_array);?>
                    <?php }?>
                    <?php if ($_smarty_tpl->tpl_vars['action_rights']->value['TRANSIT-LINK-LOAD'] == 1) {?>
                        <?php $_tmp_array = isset($_smarty_tpl->tpl_vars['isTransitModel']) ? $_smarty_tpl->tpl_vars['isTransitModel']->value : array();
if (!is_array($_tmp_array) || $_tmp_array instanceof ArrayAccess) {
settype($_tmp_array, 'array');
}
$_tmp_array[] = 'TRANSIT-LINK-LOAD';
$_smarty_tpl->_assignInScope('isTransitModel', $_tmp_array);?>
                    <?php }?>
                    <?php if ($_smarty_tpl->tpl_vars['action_rights']->value['TRANSIT-LOCAL-LOAD'] == 1) {?>
                        <?php $_tmp_array = isset($_smarty_tpl->tpl_vars['isTransitModel']) ? $_smarty_tpl->tpl_vars['isTransitModel']->value : array();
if (!is_array($_tmp_array) || $_tmp_array instanceof ArrayAccess) {
settype($_tmp_array, 'array');
}
$_tmp_array[] = 'TRANSIT-LOCAL-LOAD';
$_smarty_tpl->_assignInScope('isTransitModel', $_tmp_array);?>
                    <?php }?>
                    <?php if ($_smarty_tpl->tpl_vars['action_rights']->value['TRANSIT-OUT-FOR-DELIVERY'] == 1) {?>
                        <?php $_tmp_array = isset($_smarty_tpl->tpl_vars['isTransitModel']) ? $_smarty_tpl->tpl_vars['isTransitModel']->value : array();
if (!is_array($_tmp_array) || $_tmp_array instanceof ArrayAccess) {
settype($_tmp_array, 'array');
}
$_tmp_array[] = 'TRANSIT-OUT-FOR-DELIVERY';
$_smarty_tpl->_assignInScope('isTransitModel', $_tmp_array);?>
                    <?php }?>

                    <?php $_smarty_tpl->_assignInScope('gridClass', '');?>
                    <?php if ($_smarty_tpl->tpl_vars['isTransitModel']->value == 1) {?>
                        <?php $_smarty_tpl->_assignInScope('gridClass', 'col-lg-6 col-md-offset-3');?> 
                    <?php } elseif ($_smarty_tpl->tpl_vars['isTransitModel']->value == 2) {?>
                        <?php $_smarty_tpl->_assignInScope('gridClass', 'col-lg-5 col-lg-offset-1 col-md-6 col-md-offset-3');?>
                    <?php } elseif ($_smarty_tpl->tpl_vars['isTransitModel']->value == 3) {?>
                        <?php $_smarty_tpl->_assignInScope('gridClass', 'col-lg-4 col-lg-offset-2 col-md-6 col-md-offset-3');?> 
                    <?php } else { ?>
                        <?php $_smarty_tpl->_assignInScope('gridClass', 'col-lg-3');?> 
                    <?php }?>

                    <div class="row hidden" id="add-ogpl-list-container">
                        <br>
                                                <?php if ($_smarty_tpl->tpl_vars['action_rights']->value['TRANSIT-DIRECT-LOAD'] == 1) {?>
                        <div class="<?php if (!$_smarty_tpl->tpl_vars['cargo_setting']->value->transitMode[4]) {?>col-lg-4<?php } else { ?>col-lg-3<?php }?>">
                            <div class="panel panel-default">
                        ...
                        <div class="<?php if (!$_smarty_tpl->tpl_vars['cargo_setting']->value->transitMode[4]) {?>col-lg-4<?php } else { ?>col-lg-3<?php }?>">
                            <div class="panel panel-default">
                                <div class="panel-body p-5">
                                    <h4 class="transit-title"><?php echo lang('hub');?>
 Load</h4>
                                </div>
                            </div>
                            ...
                            <div class="row mt-10 d-flex">
                                <div class="col-lg-8 pr-5">
                                    <div class="panel panel-default">
                                        <div class="heading_b bold"><?php echo lang('hub');?>
 Loaded</div>
                                        <div class="panel-body p-0">
                            ...
                            <br>
                            <h5 class="bold"><?php echo lang('hub');?>
 Load Summary</h5>
                            <div class="panel panel-default">
                                <div class="panel-body p-0">
                                    <table class="table table-bordered mb-0">
                        ...
                        <?php }?>
                                                ...
                                                <?php if ($_smarty_tpl->tpl_vars['action_rights']->value['TRANSIT-OUT-FOR-DELIVERY'] == 1) {?>
                            <?php if ($_smarty_tpl->tpl_vars['cargo_setting']->value->transitMode[4]) {?>
                                <div class="col-lg-3">
                                    <div class="panel panel-default">
                                        <div class="panel-body p-5">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 text-right">
                                            <div class="alert pull-left" id="save-transitv3-action-state" style="display: none;width: 60%;text-align:left;"></div>
                                                ...
                                                <?php if ($_smarty_tpl->tpl_vars['ogpl']->value->fromStation->code == $_smarty_tpl->tpl_vars['login_station']->value) {?>
                                                <button class="btn btn-warning <?php if (!$_smarty_tpl->tpl_vars['ogpl']->value || (isset($_smarty_tpl->tpl_vars['odoDetails']->value) && $_smarty_tpl->tpl_vars['odoDetails']->value->startOdometer > 0) || (!$_smarty_tpl->tpl_vars['odoDetails']->value && $_smarty_tpl->tpl_vars['show_end_odo']->value == 0)) {?>hide<?php }?>" id="start-transit-btn" type="button" onclick="showStartTripDialog(true);">Start Trip</button>
                                               <?php } else { ?>
                                                   <?php if ($_smarty_tpl->tpl_vars['odoDetails']->value->fromOdometerRange > 0) {?>
                                                       <button class="btn btn-warning <?php if (!$_smarty_tpl->tpl_vars['ogpl']->value || (isset($_smarty_tpl->tpl_vars['odoDetails']->value) && $_smarty_tpl->tpl_vars['odoDetails']->value->startOdometer > 0) || (!$_smarty_tpl->tpl_vars['odoDetails']->value && $_smarty_tpl->tpl_vars['show_end_odo']->value == 0)) {?>hide<?php }?>" id="start-transit-btn" type="button" onclick="showStartTripDialog(true);">Start Trip</button>
                                                   <?php }?>
                                               <?php }?>
                                            <?php } else { ?>
                                                <?php if (isset($_smarty_tpl->tpl_vars['odoDetails']->value) && $_smarty_tpl->tpl_vars['odoDetails']->value->endOdometer == 0 && $_smarty_tpl->tpl_vars['ogpl']->value->fromOrganization->code != $_smarty_tpl->tpl_vars['login_branch']->value) {?>
                                                    <?php if ($_smarty_tpl->tpl_vars['OrginOdoDetails']->value->startOdometer > 0) {?>
                                                        <button class="btn btn-danger" id="end-transit-btn" type="button" onclick="makeEndTrip('<?php echo $_smarty_tpl->tpl_vars['ogpl']->value->code;?>
','<?php echo $_smarty_tpl->tpl_vars['ogpl']->value->busVehicle->code;?>
','<?php echo $_smarty_tpl->tpl_vars['ogpl']->value->toOrganization->code;?>
');">End Trip</button>
                                                    <?php }?>
                                                <?php } else { ?>
                                                  <button class="btn btn-warning <?php if (!$_smarty_tpl->tpl_vars['ogpl']->value || (isset($_smarty_tpl->tpl_vars['odoDetails']->value) && $_smarty_tpl->tpl_vars['odoDetails']->value->startOdometer > 0) || (!$_smarty_tpl->tpl_vars['odoDetails']->value && $_smarty_tpl->tpl_vars['show_end_odo']->value == 0)) {?>hide<?php }?>" id="start-transit-btn" type="button" onclick="showStartTripDialog(true);">Start Trip</button>
                                            ...
                                            <?php if ($_REQUEST['transitCode'] != '') {?>
                                                <a class="tab-link" href="#cargo/ogpl-chart-details?transitCode=<?php echo $_REQUEST['transitCode'];?>
&date=" title="View Chart" target="_blank" onclick="return checkOdoUpdation();"><button class="btn btn-secondary hide" type="button" id="view-chart-btn" style="color: #000;">View Chart</button></a>
                                            <?php }?>
                                            <button class="btn btn-primary hide" type="button" id="transit-complete-btn" onclick="saveTransitV3('post');">Save</button>
                                            <?php if ($_smarty_tpl->tpl_vars['action_rights']->value['LR-SPLTUP'] == 1) {?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                    ...
                    <div id="start-trip-expense">
                        ...
                        <div class="row">
                        <?php if ($_smarty_tpl->tpl_vars['namespace']->value === "seenutransports" && isset($_smarty_tpl->tpl_vars['ownershipTypeing']->value['OWN'])) {?>
                            <div class="col-md-4">
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                        ...
                        <?php } elseif ($_smarty_tpl->tpl_vars['namespace']->value === "seenutransports" && isset($_smarty_tpl->tpl_vars['ownershipTypeing']->value['HIRE'])) {?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                        ...
                        <?php } elseif ($_smarty_tpl->tpl_vars['namespace']->value === "seenutransports" && isset($_smarty_tpl->tpl_vars['ownershipTypeing']->value['ATCH'])) {?>
...
<?php echo '<script'; ?>
 id="vehicle-select-tpl" type="text/html">
    <div class="row">
        <div class="col-xs-7">
...
<div class="panel panel-default popup-split none">
    <div class="panel-body">
        ...
        <div class="mt-2 link-lr-section lr-card" style="margin-top: 10px;">
            <div class="lr-card-header"><?php echo lang('hub');?>
 Load LR</div>
...
';
    ...
    var localLoad='<?php echo $_REQUEST['INTRNT'];?>
';
    var directLoad='<?php echo $_REQUEST['TRNT'];?>
';
    var OGPLEdit = <?php echo json_encode($_smarty_tpl->tpl_vars['ogpl']->value);?>
;
    var OGPLFormData = {};
    var OGPLTemplates = <?php echo json_encode($_smarty_tpl->tpl_vars['ogpltpl']->value);?>
;
    var OGPLVehicles = <?php echo json_encode($_smarty_tpl->tpl_vars['vehicles']->value);?>
;
    var driversData = <?php echo json_encode($_smarty_tpl->tpl_vars['drivers']->value);?>
;
    var supervisorData = <?php echo json_encode($_smarty_tpl->tpl_vars['branchContact']->value);?>
;
    var drivers = <?php echo json_encode($_smarty_tpl->tpl_vars['drivers']->value);?>
;
    var OGPLtpl = <?php echo json_encode($_smarty_tpl->tpl_vars['ogpltpl']->value);?>
;
    var user_login_station = <?php echo json_encode($_smarty_tpl->tpl_vars['login_station']->value);?>
;
    var user_login_station_name = <?php echo json_encode($_smarty_tpl->tpl_vars['login_station_name']->value);?>
;
...
;
    var linkVehicleCode = <?php echo json_encode($_smarty_tpl->tpl_vars['linkVehicleCode']->value);?>
;
    var linkTransitType = <?php echo json_encode($_smarty_tpl->tpl_vars['linkTransitType']->value);?>
;
    var zoneData = <?php echo json_encode($_smarty_tpl->tpl_vars['zone']->value);?>
;
...
;
    var localTransitSearchData = <?php echo json_encode($_smarty_tpl->tpl_vars['localTransitSearchData']->value);?>
;
    var branches = <?php echo json_encode($_smarty_tpl->tpl_vars['branches']->value);?>
;
    var cargo_additional = '<?php echo json_encode($_smarty_tpl->tpl_vars['cargo_additional']->value);?>
';
    var action_rights = '<?php echo json_encode($_smarty_tpl->tpl_vars['action_rights']->value);?>
';

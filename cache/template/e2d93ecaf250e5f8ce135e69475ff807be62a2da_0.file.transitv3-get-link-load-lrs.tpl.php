<?php
/* Smarty version 3.1.34-dev-7, created on 2024-05-27 16:02:00
  from 'E:\xampp\htdocs\cargo\application\views\site\cargo\transitv3-get-link-load-lrs.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_665461204b9e00_70203107',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e2d93ecaf250e5f8ce135e69475ff807be62a2da' => 
    array (
      0 => 'E:\\xampp\\htdocs\\cargo\\application\\views\\site\\cargo\\transitv3-get-link-load-lrs.tpl',
      1 => 1716451514,
      2 => 'file',
    ),
  ),
...
function content_665461204b9e00_70203107 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'E:\\xampp\\htdocs\\cargo\\application\\third_party\\Smarty\\plugins\\modifier.date_format.php','function'=>'smarty_modifier_date_format',),));
echo '<script'; ?>
 type="text/html" id="link-load-lr-body">
    <?php $_smarty_tpl->_assignInScope('total_lr', 0);?>
    <?php $_smarty_tpl->_assignInScope('total_art', 0);?>
    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['link_load_lr']->value, 'row', false, 'k');
if ($_from !== null) {
...
-to-branch">
 ...
 <span class="link-loaded-art text-muted text-small"></span></td>
            <td><?php echo $_smarty_tpl->tpl_vars['row']->value['lr'];?>
 <span class="link-loaded-lr text-muted text-small"></span></td>
        </tr>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
 ...
 <span class="text-muted text-small" id="link-total-loaded-art" style="color: #fff;"></span></td>
        <td><?php echo $_smarty_tpl->tpl_vars['total_lr']->value;?>
 <span class="text-muted text-small" id="link-total-loaded-lr" style="color: #fff;"></span></td>
    </tr>
<?php echo '</script'; ?>
>
...
?>
        <button onclick="scrollingLink('<?php echo $_smarty_tpl->tpl_vars['row']->value['alphabet'];?>
', 'HULD');" data-letter="<?php echo $_smarty_tpl->tpl_vars['row']->value['alphabet'];?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
    ...
    <div class="pull-right d-flex"> 
        <div class="getLrs d-flex" style="margin-right:20px;">
            ...
            <button onclick="getCargoRow('link','<?php echo $_smarty_tpl->tpl_vars['body']->value['queryCode'];?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                ...
                <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['link_load_lr']->value, 'list');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['list']->value) {
?>
                    <tr>
                        <td colspan="14" align="left" class="active HULD_leter_tr_<?php echo ucfirst(substr($_smarty_tpl->tpl_vars['list']->value['name'],0,1));?>
">
                            <div class="d-flex align-items-center">
                                <input type="checkbox" onchange="selectBranchLinkLoadTransitLrs(this, '<?php echo $_smarty_tpl->tpl_vars['list']->value['name'];?>
');checkHandleLink();" />
                                <span class="mr_l_1_em"><?php echo $_smarty_tpl->tpl_vars['list']->value['name'];?>
</span>
                                <select class="form-control linkBranchSelect1" data-list-name="<?php echo $_smarty_tpl->tpl_vars['list']->value['name'];?>
                        ...
                        <tr class="<?php if ($_smarty_tpl->tpl_vars['allowloadstatus']->value == 1) {?>bg-success<?php } elseif ($_smarty_tpl->tpl_vars['allowloadstatus']->value == 2) {?>bg-warning<?php } elseif ($_smarty_tpl->tpl_vars['allowloadstatus']->value == 3) {?>bg-danger<?php }?>">
                            <td align="center">
                                <?php if ($_smarty_tpl->tpl_vars['allowloadstatus']->value == 1) {?>
                                    <input type="checkbox" onclick="checkHandleLink();" class="ogpl-new-linkload-items" data-listname="<?php echo $_smarty_tpl->tpl_vars['list']->value['name'];?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
 ...
 - <?php echo $_smarty_tpl->tpl_vars['row']->value->to_station_name;?>
                            ...
                            <td align="left">
                                ...
                                <?php if ($_smarty_tpl->tpl_vars['allowloadstatus']->value == 1) {?>
                                    <select class="link-load-branch-sel form-control link-load-branch linkBranchSelect2" data-list-name="<?php echo $_smarty_tpl->tpl_vars['list']->value['name'];?>
">
                                        <?php if (count($_smarty_tpl->tpl_vars['tload_branches']->value) > 0) {?>
                                            <option value="">Select a branch</option>
                                        <?php }?>
...
?>
                                                                    <div class="custom-checkbox link-<?php echo $_smarty_tpl->tpl_vars['row']->value->cargo_code;?>
"> 
                                                                        <input type="checkbox" onclick="checkAllValidation(<?php echo $_smarty_tpl->tpl_vars['row']->value->total_item_count;?>
,'<?php echo $_smarty_tpl->tpl_vars['row']->value->cargo_code;?>
','link');" id="checkbox<?php echo $_smarty_tpl->tpl_vars['art_id']->value;?>
_<?php echo $_smarty_tpl->tpl_vars['box']->value;?>
-link" value="<?php echo $_smarty_tpl->tpl_vars['box']->value;?>
...
" class="custom-control-input linkload" data-tobranch="<?php echo $_smarty_tpl->tpl_vars['row']->value->to_organization_code;?>
" data-from="<?php echo $_smarty_tpl->tpl_vars['row']->value->from_station_code;?>
" data-to="<?php echo $_smarty_tpl->tpl_vars['row']->value->to_station_code;?>
" data-oldtransitorg="<?php echo $_smarty_tpl->tpl_vars['row']->value->transit_organization_code;?>
" data-oldtransitstn="<?php echo $_smarty_tpl->tpl_vars['row']->value->transit_station_code;?>
...
_<?php echo $_smarty_tpl->tpl_vars['box']->value;?>
-link"> <?php echo $_smarty_tpl->tpl_vars['box']->value;?>
</label>
                                                                    </div>
                                                                <?php
}

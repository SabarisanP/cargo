                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-md-3">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="text" name="fromDate" class="form-control sdate" id="gen_invoice_date_range" readonly placeholder="Today" value="{implode(' | ', array_filter([$ffromDate|date_format:'%d-%m-%Y', $ftoDate|date_format:'%d-%m-%Y']))}">
                                                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                            </div>
                                                        </div>
                                                        <div class="form-group col-md-2">
                                                            <label for="gen_invoice_vendor_code">{lang('vendor')}</label>
        ...
        <form role="form" id="form1" class="form-horizontal">
            <div class="col-lg-12 p_l_n p_r_n">
                ...
                <div class="pull-right">
                    ...
                    <label style="display: inline;float: right;">{lang('lr')} Amount :&nbsp;&nbsp;</label>
                </div>
            </div>
            ...
            {* <div class="clear_fix_both"></div> *}
            {* <br/> *}
            {if $action_rights['ADD-OTHER-INC-EXP']==1}
                <div class="col-lg-12 p_l_n p_r_n">

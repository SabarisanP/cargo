<table border='1'>
    <tr>
        <td  colspan="6" align="center"><b>{iflang('Organization Wise Report')}</b></td>
    </tr>
    <tr>
...
<table border='1'>
            ...
            {foreach item=val from=$result key=key}
                ...
                {foreach item=row from=$val key=t}
                    ...
                    <tr> 
                        ...
                        <td  align="left"  data-format="{$xlformat['currency']}"> {$row->total_transaction_amount|inr_format}</td>
                        <td align="center">{$row->total_item_count}</td>
    ...
    {if $result|count}
        <tfoot>
            <tr class="active">                    
                <td align="right"   colspan="27" ><b>Total</b></td>  
                <td align="center" class="bold" data-format="{$xlformat['currency']}"><b>{$tot_seenu_total}</b></td>

<div class="brand_top">
    <h3>PhoneBook Cancellation Report</h3> 
                                    ...
                                    <div class="col-md-12">                                        
                                        <div class="">
                                            <div id="search-panel">                                         
                                                ...
                                                <form id='cancel_rpt' method="post" name="cancel_rpt" action="report/phonebook-cancellation-report-list" onsubmit="return false">
                                                    <div class="row">   
    ...
    <script>
        ...
        function searchCancelBooking() {
            ...
            $.ajax({
                type: "POST",
                dataType: 'html',
                url: base_url + "report/phonebook-cancellation-report-list",
                data: data,

            ...
            <tbody>
                <tr class="border-bottom">
                    <td width="15%" align="center">
                        <img src="assets/img/pkr-logo.png" alt="logo" >
                    </td>
                    <td align="left" width="60%" valign="top">
                        <table cellspacing="1">
                            <tr>
                                <td class="" align="center">
                                <span class="title2">PKR</span>&nbsp;<span class="title1">TRANSPORT</span></td>
                            </tr>
                            {if isNotNull($nsprofile->namespaceProfile->address)}
                            <tr>
                                <td class="nowrap font-7" colspan="2" align="center">                                
                                    {$nsprofile->namespaceProfile->address},<br>{$nsprofile->namespaceProfile->city} - {$nsprofile->namespaceProfile->pincode}                               
                                </td>
                            </tr>
                            {/if}
                            <tr>
                                <td align="center" class="font-7">Email : pkrtravel1976@gmail.com &nbsp;&nbsp; Phone: 0413-2358239</td>
                            </tr>
                            <tr>
                                <td align="center" class="font-7">GSTIN : 34AAQFP1410R1ZV &nbsp;&nbsp; PAN: AAQFP1410R &nbsp;&nbsp; Regd No: 360/2014</td>
                            </tr>
                            <tr>
                                <td align="center" class="font-9">PONDY * MADURAI * SIVAKASI * RAJAPALAYAM * NAGERCOIL</td>
                            </tr>
                        </table>
                    </td>
                    <td width="25%">

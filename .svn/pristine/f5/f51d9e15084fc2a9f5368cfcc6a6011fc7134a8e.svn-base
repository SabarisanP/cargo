<div class="brand_top">
    ...
    <div class="text-right noprint" id="excl_cons" style="display:none">
        <div class="btn-group btn-group-sm">
            <button class="btn btn-default" onclick="exportCargoDeliveryExcel_v2()"><i class="fa fa-download fa-lg"></i>Excel</button>
    ...
    <div class="row">
        <div class="col-md-12 note text-muted noprint">
            ...
            Shows the booking details based on the "Delivery date" range along with filters.
        </div>
    </div>
</div>
                                            ...
                                            <div id="search-panel">
                                                ...
                                                <form id='con_bk_rpt' method="get" name="con_bk_rpt" action="cargo/booking-report-list" onsubmit="return false">
                                                    <div class="row">
                                                        ...
                                                        {if $action_rights['CGO-DBR-USER-FLTR']>0}
                                                            <div class="form-group col-md-2">
                                                        ...
                                                        {if $action_rights['CGO-VIEW-SAME-BRNCH-LR']==0}
                                                            <div class="form-group col-md-2">
                                                        ...
                                                        <div class="form-group col-md-2">
                                                            ...
                                                            <div class="input-group col-md-12">
                                                                <select id="bkg_group_by" name="groupBy" class="form-control">
                                                                    ...
                                                                    <option value="SUMMARY" {if $namespace == 'rajeshcargo' || $namespace=="rajeshexpress"}selected{/if}>Summary</option>
                                                                </select>
                                                            </div>
                                                        </div>
...
{literal}
    <script>
        ...
        function exportCargoDeliveryExcel_v2() {
            document.con_bk_rpt.action = "cargo/delivery-report-list-v2";
        ...
        function searchCargoBookingBooking_v2() {
            ...
            $.ajax({
                type: "GET",
                dataType: 'html',
                url: base_url + "cargo/delivery-report-list-v2",
                data: data,

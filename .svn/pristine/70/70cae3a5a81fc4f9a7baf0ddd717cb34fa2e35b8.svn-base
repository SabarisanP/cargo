<div class="brand_top">
    <h3>Orbit Transactions Report </h3> 
</div>
                                    ...
                                    <div class="col-md-12">                                        
                                        <div class="">
                                            ...
                                            <div id="search-panel">                                         
                                                ...
                                                <form id='brd_pnt' method="post" name="brd_pnt" action="report/orbit-accounts-report-list" onsubmit="return false">
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-3">        
                                                            ...
                                                            <button class="btn btn-success" type="button"  onclick="exportObitExcel();" >Download</button>

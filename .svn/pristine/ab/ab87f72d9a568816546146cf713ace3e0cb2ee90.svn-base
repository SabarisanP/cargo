...
{for $iter=1 to $smarty.request.count}
    <table width="100%">
        <tr>
            <td width="100%" align="center">
                <img src="assets/img/Thamizhi-Header.jpg" alt="logo" style="max-width: 100%;"><br>
            </td>
        </tr>
    </table>
        ...
        <tr>
            <td width="65%">
                ...
                <table width="100%" cellpadding="2" class="table bordered ">
                    ...
                    <tr>
                        <td align="left" width="50%"><b>{$summary->fromOrganization->name}</b>
                        ...
                        <td align="left" width="50%"><b>{$summary->toOrganization->name}</b>
                ...
                <table width="100%" cellpadding="3" class="table bordered ">
                    <tr class="success" style="background-color:#64b92a;">
                        ...
                        <td align="center" class="bold" width="50%">Article</td>                                 
                        <td align="center" class="bold" width="20%">UOM</td>
                        <td align="center" class="bold" width="20%">Quantity</td>
                        {* <td align="center" class="bold" width="15%">Rate</td>
                        <td align="center" class="bold" width="15%">Total</td> *}
                        {else}
                        <td align="center" class="bold" width="10%">S No</td>
                        <td align="center" class="bold" width="60%">Article</td>                                 
                        <td align="center" class="bold" width="30%">Quantity</td>
                        {* <td align="center" class="bold" width="20%">Rate</td>
                        <td align="center" class="bold" width="20%">Total</td> *}
                        {/if}
                    </tr>
                    <tbody class="body_table" >
                        ...
                        {foreach from=$summary->itemDetails item=article name=carArt}
                            <tr>
                                ...
                                <td align="left">
                                    {$article->cargoItem->name|truncate:50} 
                                </td>
                                {if $action_rights['CARGO-UNITS']==1}
                                <td align="center">
                                    {$article->unitValue}
            ...
            <td width="32%" valign="top">
                ...
                <tr style="font-size:10px;font-weight: bold;">
                    <td align="left" width="35%" class="bold">Booked To :</td>
                    <td align="left" width="65%">{$summary->toOrganization->name}</td>
                </tr>
                </table>
                <br/><br/>

                <table width="100%" cellpadding="3" class="table" style="border: 1px solid #000;">
                    <tbody class="body_table" >
                    <tr>
                    ...
                    <tr>
                        <td align="left" width="50%" class="bold" style="border-right: 0.1px solid #000;">Loading Charges</td>
    ...
    <table width="100%" cellpadding="1">
        <tr class="success" >
            <td align="center" class="bold">Unloading / Service Charges Paid by Party at the time of Delivery</td>

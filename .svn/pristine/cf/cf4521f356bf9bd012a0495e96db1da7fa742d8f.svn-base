...
<table style="padding:10px 10px;border: 1px solid #000;">
    ...
    {assign var=other_charge_total value=0}
    {foreach from=$income_expense item=row}
        {if $row->transactionType == 'EX'}
            {assign var=other_charge_total value=$other_charge_total-$row->value}
    ...
    <tr>
        <td><b>Payment</b></td>
        <td><b>:</b></td>
        <td>Cheque/DD in favour of '<b> KMP Speed Parcel Service </b>' Only.</td>
        <td><b>Total Consignment</b></td>
        <td><b>:</b></td>
        <td>{$total_lr}</td>
    </tr>
    <tr>
        <td colspan="3" rowspan="2" style="line-height: 15px;"><b>Bank A/C Details :</b><br><b>Name : KMP Speed Parcel Service</b><br><b>A/C No : 003661900001600</b><br><b>Branch : Avinashi Road, Coimbatore</b><br><b>IFSC : YESB0000036</b><br></td>
        <td><b>Total Qty</b></td>
        <td><b>:</b></td>
        <td>{$total_qty}</td>
    </tr>
    <tr>
        ...
        <td><b>:</b></td>
        <td><b>Rs. {($total+$other_charge_total)|inr_format}/-</b></td>
    </tr>
    <tr>
        <td></td>
        <td></td>
        <td></td>
        <td></td>
        <td align="left" colspan="2">For <b>KMP SPEED PARCEL SERVICE</b></td>
    </tr>
    <tr>
        <td></td>
        <td></td>
...
<table style="padding:5px 4px;">
    ...
    <tbody>
        ...
        {* {if $income_expense|count} *}
            <tr style="font-weight:bold;">
                <td align="right" colspan="2" style="border-bottom: 1px solid #000000;border-left: 1px solid #000000;">Total Amount</td>

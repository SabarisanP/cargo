<div class="brand_top">
    <h3>{iflang('Pending GC Dispatch Report')}</h3> 
    ...
    <div class="row">
        <div class="col-md-12 note text-muted noprint">
            ...
            Shows the pending loading status LR's
        </div>
    </div>
</div>
                                    ...
                                    <div class="col-md-12">                                        
                                        <div class="">
                                            <div id="search-panel">                                         
                                                ...
                                                <form id='con_rv_rpt' method="post" name="con_rv_rpt" action="cargo/pending-gc-dispatch-report-list" onsubmit="return false;">
                                                    <div class="row">   
                                                        ...
                                                        {if $action_rights['PND-DISP-ALL-BRANCH']>0}
                                                        <div class="form-group col-md-2">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-2">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <button class="btn btn-success" type="button"  onclick="dispatchReport();">Search</button>&nbsp;
                                                                <button type="button" class="btn btn-default btn-clear" onclick="clearDispatchReport();">Clear</button>
                                                            </div>
                                                        </div>        
                                                    </div>
                                                </form> 
    ...
    <script>
        ...
        function dispatchReport() {
            ...
            $.ajax({
                type: "POST",
                dataType: 'html',
                url: base_url + "cargo/pending-gc-dispatch-report-list",
                data: data,

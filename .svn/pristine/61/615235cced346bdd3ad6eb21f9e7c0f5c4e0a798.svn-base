<div class="brand_top">
    <h3>Driver Duty Allocation Report</h3> 
    
    <div class="text-right hidden" id="d_head_export_panel">
        <div class="btn-group btn-group-sm">
            <button class="btn btn-default" onclick="exportAllocationDetails()"><i class="fa fa-download fa-lg"></i>Excel</button>
        </div>
    </div>    
</div>
<div id="main_wrapper">
            ...
            <div class="row">
                <div id="contents" class="col-lg-12"> <br>
                    ...
                    <div class="row">                        
                                    ...
                                    <div class="col-md-12">                                        
                                        <div class="">
                                                ...
                                                <div id="search-panel">                                         
                                                    ...
                                                    <form name='driver_duty_report' method="post" action="report/driver-duty-allocation-report-list" onsubmit="return false;">
                                                        ...
                                                        <div class="form-group col-md-2">
                                                            <label class="sr-only" for="driver-code">Driver Name</label>
                                                            <div class="input-group col-md-12">
                                                                <select class="form-control" id="driver-code" name="driverCode">
                                                        ...
                                                        <button class="btn btn-success" type="button"    onclick="getDriverDetails();" >Generate</button>
                        ...
                        <div class="row hidden" id="driver-duty-list-container">
                            <br>
                            <div class="col-lg-12">
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        <div id="driver-duty-list"></div>                                    
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    {literal}
        <script>
            ...
            function getDriverDetails() {
                $('#driver-duty-list').html('');
                var data = {};
                data.from = $('#date_from').val();
                data.to = $('#date_to').val();
                data.driverCode = $('#driver-code').val();
                ...
                var html = "";
                $('#date_to').removeClass('inp_error');
                $('#driver-duty-list-container').removeClass('hidden');
                $('#driver-duty-list').html(loading_popup);
                $.ajax({
                    type: "POST",
                    dataType: 'html',
                    url: base_url + "report/driver-duty-allocation-report-list",
                    data: data,
                    success: function(response) {
                        $('#driver-duty-list').html(response);
            ...
            function clearReport() {
                ...
                $('#date_to').val('');
                $('#driver-code').val('');
                $('#driver-duty-list-container').addClass('hidden');
                $('#driver-duty-list').html('');
            ...
            function exportAllocationDetails() {
                document.driver_duty_report.target = "irm_downloader";
                $('#export').val(1);
                document.driver_duty_report.submit();
                return;
            }

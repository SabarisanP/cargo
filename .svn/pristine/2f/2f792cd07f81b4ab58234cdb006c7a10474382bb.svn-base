    ...
    <table width="100%">
        <tr>
            <td width="100%" align="center">
                <img src="assets/img/madhuraja-header.jpg" alt="logo" style="max-width: 100%;">
            </td>
        </tr>
    </table>
        ...
        <tr>
            <td width="65%">
                ...
                <table width="100%" cellpadding="3" class="table bordered ">
                    <tbody class="body_table">
                        <tr>
                            <td align="center" colspan="2" class="bold" width="50%">Shri Maduraja Parcel Service</td>
                            <td align="center" colspan="2" class="bold" width="50%">City Union Bank, Srivilliputtur</td>
                        </tr>
                        <tr>
                            <td align="center" colspan="2" class="bold">A/c No : 510909010130080</td>
                            <td align="center" class="bold">IFSC : CIUB0000328</td>
                            <td align="center" class="bold">GPay : 9994061499</td>
                        </tr>
                    </tbody>
                </table>
            </td>
            ...
            <td width="32%" valign="top">
                <table align="left">
                    ...
                    <tr style="font-size:14px;font-weight: bold;">
                        <td align="center" colspan="2" class="bold" style="padding-bottom: 20px;">{$summary->deliveryType->name|upper}</td>
                    </tr>
                </table>

<table border='1'>
    ...
    <tr>
        <td colspan="6" align="center"><b>Agent / Branch Collection : Based On Booked Date</b></td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="3" align="left">{if $branchName}<b>Branch :</b>&nbsp; {$branchName}{if $userName},&nbsp; <b>User :</b>&nbsp; {$userName}{/if}{/if}</td>
            ...
            <table class="table table-bordered" width="99%">
                ...
                <tbody class="body_table">
                    ...
                    {foreach key=user_name item=list from=$userwise}
                        <tr class="active">
                            <td colspan="16" align="center">{$user_name}</td>
                        </tr>

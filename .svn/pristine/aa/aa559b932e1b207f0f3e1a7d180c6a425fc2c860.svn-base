                                            ...
                                            <div id="search-panel">    
                                                <form id='mytrans_form' name="trans_form" method="post"  onsubmit="return false">
                                                    <div class="row">   
                                                        ...
                                                        {if $action_rights['TSR-USER-FILTER']==1}        
                                                        <div class="form-group col-md-2">
                                                            <label  for="trns_rpt_date_to">Users</label>
                                                            <div class="input-group col-md-12">
                                                                <select id="tsr_user_code" name="tsr_user_code"  class="form-control" >
                                                                    {foreach name=o item=row from=$entity}
                                                                        <optgroup label="{$row['name']}">
                                                                            {foreach name=o item=usr from=$row["userlist"]}
                                                                                <option value='{$usr->code}|{$usr->name}'>{$usr->name}</option>
                                                                            {/foreach}
                                                                        </optgroup>
                                                                    {/foreach}
                                                                </select>       
    ...
    {literal}
        <script>
            ...
            function searchTransBooking() {
                ...
                data.user_code = $('#tsr_user_code').val();
                ...
                $.ajax({
                    type: "POST",
                    dataType: 'html',
                    url: base_url + "report/agent-trip-payment-list",
                    data: data,
                    success: function (response) {

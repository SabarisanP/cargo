            ...
            <tbody>
                <tr>
                    <td colspan="2" align="center" class="font-10">
                        <img src="assets/img/kknexpress-header.jpg"> <br>
                        {$summary->fromOrganization->address1|capitalize}, &nbsp;{$summary->fromOrganization->address2|capitalize} <br>
                        {$summary->fromOrganization->contact} &nbsp; | &nbsp; <span class="bold"> GST : {if isNotNull($summary->tax->gstin)} {$summary->tax->gstin} {else} 32BSHPS8877B2ZD {/if} </span><br>
                    </td>
                </tr>

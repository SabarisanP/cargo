<div class="brand_top">
    ...
    <span class="align-right">{if $action_rights['SM-ADD']>0}<a href="javascript:;" class="btn btn-success  btn-sm" {if $action_rights['SM-ADD']!=2}onclick="editStation();"{/if}>Add New Station</a>{/if}</span></div>
<div id="main_wrapper">

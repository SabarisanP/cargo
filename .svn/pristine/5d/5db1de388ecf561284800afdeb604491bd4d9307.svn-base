                                            ...
                                            <div id="search-panel">                                         
                                                ...
                                                <form id="ogpl_form" method="post" name="ogpl_form" action="" onsubmit="return false">
                                                    <div class="row">   
                                                        ...
                                                        {if $action_rights['OGPL-UNL-ALLBRNC']>0}
                                                            <div class="form-group col-md-2">
                                                        ...
                                                        <div class="form-group col-md-2">
                                                            <label for="ogpl_alias_code">{lang('ogpl')} Number</label>
                                                            <input type="text" name="aliasCode" class="form-control sdate initialism" id="ogpl_alias_code" placeholder="{lang('ogpl')} Number" value="{$faliasode}">
                                                        </div>

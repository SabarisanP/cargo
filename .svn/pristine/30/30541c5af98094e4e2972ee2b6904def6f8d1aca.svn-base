            ...
            <tbody>
                <tr class="border-bottom">
                    <td width="15%" align="center">
                        <img src="assets/img/madhuraja-logo.png" alt="logo">
                    </td>
                    <td align="left" width="60%" valign="top">
                        <table cellspacing="1">
                            <tr>
                                <td class="" align="center">
                                    <span class="title2">SHRI MADHURAJA</span>&nbsp;<span class="title1">PARCEL SERVICE</span>
                                </td>
                            </tr>
                            ...
                            {/if}
                            <tr>
                                <td align="center" class="font-7">Email : ramasubbu.bala@gmail.com &nbsp;&nbsp; Phone: 9600007266 | 8489905266</td>
                            </tr>
                            <tr>
                                <td align="center" class="font-7">GSTIN : 33AKSPR4273L2ZF &nbsp;&nbsp; PAN: AKSPR4273L &nbsp;&nbsp;</td>
                            </tr>
                        </table>
                    </td>
                    <td width="25%">

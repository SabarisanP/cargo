                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-md-3">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="text" name="fromDate" class="form-control sdate" id="cons_rpt_date_range" readonly placeholder="Today" value="{implode(' | ', array_filter([$ffromDate|date_format:'%d-%m-%Y', $ftoDate|date_format:'%d-%m-%Y']))}">
                                                        ...
                                                        <div class="form-group col-md-2">
                                                            ...
                                                            <div class="input-group col-md-11">
                                                                <select id="prebook-status" name="preBookStatus" class="form-control">
                                                                    ...
                                                                    {foreach item=status from=$prebook_status key=key}

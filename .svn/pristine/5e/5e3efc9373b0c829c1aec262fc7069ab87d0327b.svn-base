<div class="brand_top">
    <h3>Business Revenue Detailed Report</h3> 
                                    ...
                                    <div class="col-md-12">                                        
                                        <div class="">
                                            <div id="search-panel">                                         
                                                ...
                                                <form id='con_rv_rpt' method="post" name="con_rv_rpt" action="cargo/business-revenue-detailed-report-list" onsubmit="return false;">
                                                    <div class="row">   
                                                        ...
                                                        <div class="form-group col-md-2">
                                                            <label  for="rev_rpt_date_to">Transit Type</label>
                                                            <div class="input-group col-md-12">
                                                                <select id="rev_rpt_transittype" name="transitType"  class="form-control" >
                                                                    <option value='TRNT'>{lang('ogpl')}</option>
                                                                    <option value='INTRNT'>{lang('ogpl_local_transit')}</option>
                                                                </select>       
                                                            </div>
                                                        </div>
                                                    </div>
...
{literal}
    <script>
        ...
        function revenueReport() {
            ...
            data.transitType = $('#rev_rpt_transittype').val();
            ...
            $.ajax({
                type: "POST",
                dataType: 'html',
                url: base_url + "cargo/business-revenue-detailed-report-list",
                data: data,

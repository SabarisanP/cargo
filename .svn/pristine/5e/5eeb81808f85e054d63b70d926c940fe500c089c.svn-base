                                    ...
                                    <div class="col-md-12">                                        
                                        <div class="">
                                            ...
                                            <div id="search-panel">                                         
                                                ...
                                                <form id='brd_pnt' method="post" name="brd_pnt" action="report/travel-status-report-list" onsubmit="return false">
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-2">
                                                            <label class="sr-only" for="date_to">Status</label>
                                                            <div class="input-group">
                                                                <select id="status_id" name="staion" class="form-control sdate">
                                                                    <option value="">Select a status</option>
                                                                    {foreach item=name key=code from=$travel_status}
...
{literal}
    <script>
        ...
        function searchBoardingPointReport() {
            ...
            var err = 0;
            if (data.status == '') {
                $('#status_id').addClass('inp_error');
                err++;
            } else {
                $('#status_id').removeClass('inp_error');
            }
            ...
            $.ajax({
                type: "POST",
                dataType: 'html',
                url: base_url + "report/travel-status-report-list",
                data: data,

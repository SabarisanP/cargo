                                ...
                                <div class="panel-body">
                                    <div class="col-md-12">
                                        <form class="form-inline" role="form">
                                            {if $action_rights['S-ADD-STATION']>0}<div class="form-group">                                
                                            ...
                                            {/if}
                                            <input type='hidden' id='s_delete' value={$action_rights['S-DELETE-STATION']}>
                                            {if $action_rights['S-ADD-STATION']>0}<button type="button" class="btn btn-success" {if $action_rights['S-ADD-STATION']!=2} onclick="addNamespaceMapping()"{/if}>Add to My Stations</button> {/if}

                                        </form> 
                                    </div>        
                                    {if $action_rights['S-ADD-STATION']>0}   <br />{/if}

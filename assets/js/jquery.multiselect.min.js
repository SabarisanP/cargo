...
function addOptionSelect(curVal, selId, e) {
    if (e.keyCode == 45) {
        tmpVal = 0;
        ...
        if (tmpVal == 1) {
            var list = document.getElementById(selId);
            list.add(new Option(curVal, curVal));
            $(".multiselect-container").append('<li style="display: list-item;"><a href="javascript:void(0);"><label class="checkbox"><input class="' + selId + '_opt_checkbox" type="checkbox" value="' + curVal + '" style="display:block;margin-left:-55px;">' + curVal + '</label></a></li>');
        }
    }
}
                                    ...
                                    <div class="col-md-12">                                        
                                        <div class="">
                                            <div id="search-panel">                                         
                                                ...
                                                <form id='con_rv_rpt' method="post" name="con_rv_rpt" action="analytics/sales-by-branch-list" onsubmit="return false;">
                                                    <div class="row">   
    ...
    <script>
        ...
        function dispatchReport() {
            ...
            $.ajax({
                type: "POST",
                dataType: 'html',
                url: base_url + "analytics/sales-by-branch-list",
                data: data,

<div class="brand_top">
    <h3>{iflang('Collections By Branch')}</h3> 
                                    ...
                                    <div class="col-md-12">                                        
                                        <div class="">
                                            <div id="search-panel">                                         
                                                ...
                                                <form id='con_rv_rpt' method="post" name="con_rv_rpt" action="analytics/collections-by-branch-list" onsubmit="return false;">
                                                    <div class="row">   
    ...
    <script>
        ...
        function dispatchReport() {
            ...
            $.ajax({
                type: "POST",
                dataType: 'html',
                url: base_url + "analytics/collections-by-branch-list",
                data: data,

                                        ...
                                        <div class="">
                                            ...
                                            <div id="search-panel">                                         
                                                ...
                                                <form id='test'>
                                                    ...
                                                    <button class="btn btn-success" type="button"    onclick="getfeedback();" >Generate</button>
...
{literal}
    <script>
        $('#date_from').datepicker({
            ...
            var end = new Date(fDate.setDate(fDate.getDate() + 30));
        ...
        function getfeedback() {
            ...
            $.ajax({
                type: "POST",
                dataType: 'html',
                url: base_url + "report/feedback-report-list",
                data: data,

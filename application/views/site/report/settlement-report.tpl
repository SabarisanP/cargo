                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <div class="col-md-12">                                        
                                    <div class="">
                                        <div id="search-panel">    
                                            <form id='pays_form' name="pays_form" method="post" action="report/settlement-report-list" onsubmit="return false" target="_blank">
                                                <div class="row">   
                                                    ...
                                                    {if $action_rights['SETT-USER-FILTER']>0} 
                                                        {if $action_rights['SETT-ONLY-NATVE-USER']>0} 
                                                            <div class="form-group col-md-2">
                                                        ...
                                                        {/if}
                                                    {else}
                                                        <input type="hidden" id="pays_trns_rpt_user_code" name="user_code" value="{$user_id}"  />
                                                    {/if}    
...
{literal}
    <script>
        ...
        $('#pays_rpt_date_to').datepicker({
            ...
            $('#pays_rpt_date_from').datepicker('setStartDate', start);
        ...
        function searchPaymentReport() {
            ...
            if (data.user_code == 'NA') {
                $('#pays_trns_rpt_user_code').addClass('inp_error');
                err++;
            }
            ...
            $.ajax({
                type: "POST",
                dataType: 'html',
                url: base_url + "report/settlement-report-list",
                data: data,
        ...
        function settlementReportPdf() {
            document.pays_form.target = "ifrm_pays_downloader";
            document.pays_form.action = "report/settlement-report-list?r="+Math.random();
            $('#pdf').val(1);

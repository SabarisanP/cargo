<div class="brand_top">
    ...
    <div class="text-right hidden" id="d_head_export_panel">
        <div class="btn-group btn-group-sm">
            <button class="btn btn-default" onclick="exportAdvancedBookingReport()"><i class="fa fa-download fa-lg"></i>Excel</button>
                                        ...
                                        <div class="">
                                                ...
                                                <div id="search-panel">                                         
                                                    ...
                                                    <form id='test'>
                                                        ...
                                                        <button class="btn btn-success" type="button"    onclick="searchAdvBooking();" >Generate</button>
        ...
        <script>
            ...
            function searchAdvBooking() {
                ...
                $.ajax({
                    type: "POST",
                    dataType: 'html',
                    url: base_url + "report/advanced-booking-list",
                    data: data,

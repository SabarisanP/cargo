...
<div id="main_wrapper">
    ...
    <script>
        ...
        function saveRecharge() {
            ...
            var err = 0;
            if ($('#t_type').val() == '') {
                $('#t_type').addClass('inp_error');
                err++;
            } else {
                $('#t_type').removeClass('inp_error');
            }
            if ($('#Rdate').val() == '') {
            ...
            $.ajax({
                type: "POST",
                dataType: 'json',
                url: base_url + "report/update-recharge",
                data: data,
        ...
        function searchReport() {
            ...
            data.acknowledment_status = $('#acknowledment_status').val();
            ...
            $.ajax({
                type: "POST",
                dataType: 'html',
                url: base_url + "report/get-recharge-list",
                data: data,
                success: function(response) {

<table border="1">
    <tr style="font-weight: bold">
        <td  colspan="10" align="center">Branch Collections Report</td>
    </tr>
    <tr style="font-weight: bold">
        <td colspan="4"><span style="font-weight: bold">Date :</span> {$smarty.request.from_date|date_format:$ns_date_format} to {$smarty.request.to_date|date_format:$ns_date_format}</td>
        <td colspan="6" align="right"><span style="font-weight: bold">Report Date/Time :</span> {date("d-m-Y h:i A")}</td>
    </tr>
</table>
<br>
...
<table border='1'>
    ...
    <tbody class="body_table">
        ...
        {/foreach}
        <tr>
            <td align='right' colspan="1" style="font-weight: bold;">Total</td>

<div class="brand_top">
    <h3>Payment Gateway Reconciliation Report</h3> 
                                    ...
                                    <div class="col-md-12">                                        
                                        <div class="">
                                                ...
                                                <div id="search-panel">                                         
                                                    ...
                                                    <form name='pg_txn_report' method="post" action="report/reconciliation-report-list" onsubmit="return false">
                                                        ...
                                                        <div class="form-group col-md-2">
                                                            <label class="sr-only" for="date_to">Transaction Type</label>
                                                            <div class="input-group">
                                                                <select id="filter_code" name="filterCode"  class="form-control" >
                                                                    <option value="CONFIRM">Confirm</option> 
                                                                    <option value="CANCEL">Cancel</option>
                                                                </select>   
                                                            </div>
                                                        </div>
                                                        <button class="btn btn-success" type="button"    onclick="getReconciliationReport();" >Generate</button>
                                                        <button type="button" class="btn btn-default btn-clear" onclick="clearReconciliationReport();">Clear</button>
    ...
    {literal}
        <script>
            ...
            function getReconciliationReport() {
                ...
                data.to = $('#date_to').val();
                data.to = $('#date_to').val();
                data.filterCode = $('#filter_code').val();
                ...
                $.ajax({
                    type: "POST",
                    dataType: 'html',
                    url: base_url + "report/reconciliation-report-list",
                    data: data,
            ...
            function clearReconciliationReport() {
                $('#date_from').val('');
                $('#date_to').val('');

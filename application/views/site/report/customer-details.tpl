            ...
            <div class="row">
                <div id="contents" class="col-lg-12"> <br>
                    ...
                    <div class="row">                        
                                    ...
                                    <div class="col-md-12">                                        
                                        <div class="">
                                                ...
                                                <div id="search-panel">                                         
                                                    ...
                                                    <form name='cus_det_report' method="post" action="report/customer-details-report-list" onsubmit="return false;">
                                                        ...
                                                        <button class="btn btn-success" type="button"    onclick="getCustomerDetails();" >Generate</button>
                        ...
                        <div class="row hidden" id="customer-details-list-container">
                            <br>
                            <div class="col-lg-12">
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        <div id="customer-details-list"></div>                                    
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    {literal}
        <script>
            ...
            function getCustomerDetails() {
                ...
                var html = "";
                $('#date_to').removeClass('inp_error');
                $('#customer-details-list-container').removeClass('hidden');
                $('#customer-details-list').html(loading_popup);
                $.ajax({
                    type: "POST",
                    dataType: 'html',
                    url: base_url + "report/customer-details-report-list",
                    data: data,
                    success: function(response) {
                        $('#customer-details-list').html(response);
            ...
            function clearReport() {
                ...
                $('#date_from').val('');
                $('#date_to').val('');
                $('#customer-details-list-container').addClass('hidden');
                $('#customer-details-list').html('');
            ...
            function exportCustomerDetails() {
                document.cus_det_report.target = "irm_downloader";
                $('#export').val(1);
                document.cus_det_report.submit();
                return;
            }

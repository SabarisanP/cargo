<table width="100%">
    <tr>
        <td  colspan="10" align="center"><span class="bold">Agent Boarding Report</td>
    </tr>
    <tr>
        <td width="50%"><span class="bold">Station :</span> {$smarty.request.staionname} &nbsp; <span class="bold">Trip Date :</span> {$smarty.request.from_date|date_format:$ns_date_format} </td>

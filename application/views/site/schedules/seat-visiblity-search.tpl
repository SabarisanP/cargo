<div style="padding:0px 10px;">                               
    <div class="pull-right"> 
        <a title="close" href="javascript:;" class="btn-lg" onclick="close_settings_popup(); " style="position:relative;"> <i class="fa fa-times-circle fa-lg"></i> </a>
    </div>            
</div>
...
<div class="box_content toggle-seat-list" style="padding:15px;">
    <div class="row"> 
        <div class="col-sm-3"> 
    ...
    <div class="row" style="padding-top:10px">        
        ...
        <div class="col-sm-3">
            <label >Release Before <a class="note" href="javascript:;" data-toggle='tooltip' title="Seats will be released automatically"><i class="fa fa-exclamation-circle"></i></a></label>
        ...
        <div class="col-sm-2">
            <label>&nbsp;</label>
            <button class="btn btn-success btn-sm" type="button" onclick="saveSeatSchedules(1)"><i class="fa fa-plus"></i>&nbsp;Add</button>
            <button  type="button" class="btn btn-default btn-sm" onclick="clearSeatVisibilty()">&nbsp;Clear</button>
        </div>  

        <div class="col-sm-4">
            <div class="err-act"></div>
        </div>
    </div>
...
<div id="toggle-seat_header">
    <table class="table seat-visibilty-list" width="100%">
        <tr>
            ...
            <th width="18%" align="center">User / Group / Route</th>
            <th width="18%" align="center">Seats</th>            
            <th width="20%" align="center">Days</th>
            <th></th>
            <th></th>
        </tr>
        ...
        {foreach item=sv from=$seatvisiblelist}
            <tr class="del-seat-{$sv->code} {if count($sv->overrideList) > 0} trhover {/if} "  {if count($sv->overrideList) > 0} data-toggle='tooltip' title="Click to view exception" onclick="toogleVisiblityExceptionOverrideList(this, '{$sv->code}')" {/if}>
                ...
                <td width="9%">
                    <a class="pTip_top" data-toggle='tooltip' title="Edit visiblity" href="javascript:;" onclick="editSeatVisiblity('{$sv->code}')">
                        <i class="fa fa-pencil fa-lg"></i>
                    </a>&nbsp;
                    <a class="pTip_top" data-toggle='tooltip' title="Delete visiblity" href="javascript:;"  onclick="deleteSeatVisiblity('{$sv->code}')">
                        <i class="fa fa-trash-o fa-lg"></i>
                    </a>&nbsp;
                    <a class="pTip_top" data-toggle='tooltip' title="Add exception / override" href="javascript:;" data-viscode="{$sv->code}" data-from="trp-set"   onclick="seatVisiblityExceptionOverride(this)">
                    ...
                    {if count($svo->busSeatLayout)<=0}
                        <tr class="seat-visibility-tab-{$sv->code} sta-exp-ovr-lst-hide ex-{$sv->code}" id="stv-eo-del-{$svo->code}" style="display:none">
                            ...
                            <td>
                                ...
                                <a class="delete pTip_top" title="Delete exception" href="javascript:;"  data-viscode="{$sv->code}" data-expcode="{$svo->code}" onclick="deleteSeatVisibilityExceptionschedules(this)">
                ...
                {foreach key=key from=$sv->overrideList item=svo}
                    {if count($svo->busSeatLayout)>0}
                        <tr class="seat-visibility-tab-{$sv->code} sta-exp-ovr-lst-hide ex-{$sv->code}" id="stv-eo-del-{$svo->code}" style="display:none">
                            ...
                            <td>
                                <a class="edit pTip_top" title="Edit exception" href="javascript:;" data-viscode="{$sv->code}" data-expcode="{$svo->code}" data-tab="stv-ovr" onclick="seatVisiblityExceptionOverride(this)">
                                    <i class="fa fa-pencil"></i>
                                </a>&nbsp;
                                <a class="delete pTip_top" title="Delete exception" href="javascript:;"  data-viscode="{$sv->code}" data-expcode="{$svo->code}" onclick="deleteSeatVisibilityExceptionschedules(this)">
                                    <i class="fa fa-trash-o"></i>
            ...
            <div id="vis-expt" class="tab-pane fade in active">
                <form role="form" id="visexp" class="form-horizontal">
                    ...
                    <div class="form-group hide">
                        ...
                        <div class="col-sm-9">
                            <textarea id="vis-exp-scd-description" class="rs_no form-control">desc search</textarea>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="pull-right" id="vis-expt-button">
                        ...
                        <button class="btn btn-success" type="button" onclick="saveVisiblityExceptionDialog(1)">Save</button>
            ...
            <div id="vis-ovr"  class="tab-pane fade">
                <form role="form" id="visover" class="form-horizontal">
                    ...
                    <div class="pull-right" id="vis-ovr-sch-button">
                        ...
                        <button class="btn btn-success" type="button" onclick="saveVisiblityOverrideDialog(1)">Save</button>
                        <button class="btn btn-default" type="button" onclick="cancelVisiblityExceptionDialog()">Cancel</button>
                    </div>
                </form>
            </div>
...
<input type="hidden" id="bus-type-sch-seat" value="{$sch_bus_code}" />
<script>
    var id = gct();

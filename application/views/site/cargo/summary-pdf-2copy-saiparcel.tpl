...
<table width="100%" cellpadding="2">
    <tr>
        <td width="100%">
            &nbsp;<img src="assets/img/Sai-Parcel-LR-Header.jpg" alt="logo" style="max-width: 100%;">
        </td>
    </tr>
</table>
    ...
    <td width="65%">
        ...
        <table width="100%" cellpadding="3" class="table bordered ">
            <tr class="success" style="background-color:#64b92a;">
                ...
                <td align="center" class="bold" width="40%">Article</td>                                 
                <td align="center" class="bold" width="15%">UOM</td>
                ...
                {else}
                <td align="center" class="bold" width="10%">S No</td>
                <td align="center" class="bold" width="45%">Article</td>                                 

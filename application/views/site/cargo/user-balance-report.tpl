                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <div class="col-md-12">
                                        <div class="">
                                            <div id="search-panel">
                                                <form id="userbalance_report" method="post" name="userbalance_report" action="cargo/user-balance-report-list" onsubmit="return false;">
                                                    <div class="row">
    ...
    <script>
        ...
        function getUserBalanceReport() {
            ...
            $.ajax({
                type: "POST",
                dataType: 'html',
                url: base_url + "cargo/user-balance-report-list",
                data: data,

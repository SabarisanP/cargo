<div class="brand_top">
    ...
    <div class="align-right noprint">
        <a href="#cargo/ogpl-loading-sheet" class="btn btn-success  btn-sm">{lang('loading_sheet')}</a>
    	{if $action_rights['OGPL-DNLD-LR']>0}
        <a href="javascript:;" id="download-lr-btn" class="btn btn-primary btn-sm" onclick="downloadOGPLLR();" style="display: none;">Download {lang('lr')}</a>
        {/if}
    </div>
    <div class="row">
                                                ...
                                                <form id="ogpl_form" method="post" name="ogpl_form" action="" onsubmit="return false">
                                                    <div class="row">   
                                                        ...
                                                        <div class="form-group col-md-3">
                                                            ...
                                                            <input type="text" name="aliasCode" class="form-control sdate initialism" id="ogpl_alias_code" placeholder="Transit Number" value="{$faliasode}">
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-2">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="hidden" name="last_active_code" id="last_active_code" value="{$flastactive}">
                                                                ...
                                                                {* <button class="btn btn-success" type="button"  onclick="getOgplList();">Get Transit</button>&nbsp;

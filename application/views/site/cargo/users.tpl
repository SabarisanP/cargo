<div class="brand_top">
    ...
    <span class="align-right">
        ...
        {if $action_rights['USR-EDIT']>0 || $is_super_namespace==1}<button class="btn btn-primary" onclick="importBitsUsers()">Import Bits Users</button>{/if}
        {if $action_rights['USR-ADD-HIDE'] > 0}
                                                                        ...
                                                                        {foreach name=ow key=ugrpname item=ugroup from=$users} 
                                                                            ...
                                                                            <li id="usr-{$row->code}">
                                                                                <div class="" style="padding-left:10px;">
                                                                                    <a href="javascript:;" id="usr-viw-{$row->code}" onclick="userView('{$row->code}')" data-uname="{$row->username}" data-toggle="tooltip"  title="Click to view user details">
                                                                                        {$row->name}

                                                                                        {if $is_super_namespace==1}
                                                                                            {if isset($row->integrationType)}
                                                                                                <span class="label label-default">{$row->integrationType->name}</span>
                                                                                            {/if}
                                                                                        {/if}
                                                                                        {if $row->activeFlag == 0}
...
<script type="text/template" id="user_detail_view">
    ...
    <div class="btn-group pull-right">
							{if $action_rights['USR-DISABLE']>0}
...
<script type="text/html" id="cargo_commission">
    <div>
        <div class="row">
            <div class="col-sm-6">
...
<script type="text/html" id="cargo_station_commission">
    <div>
        <div class="row">
            <div class="col-sm-6">
...
<script type="text/html" id="user_branches_tpl">
...
<script type="text/html" id="user_paymenttypes_tpl">
    <div class="col-sm-6 p_l_n" id="user_paymenttypes_panel">
        ...
        <div>
            <select class="form-control" id="book_pay_type" multiple>
                {foreach key=code item=name from=$cargo_payment_status}
...
<script type="text/html" id="cargo_tds_tpl">
    <div id="cargo_tds">
        <div class="row" > 
            <div class="col-sm-6"> 
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <select class="form-control" id="user-branch" multiple>
                        {foreach item=row from=$userAssignedBranches}
    ...
    <form class="form pt10" action="#">
        ...
        <div class="row">
            <div class="col-md-4 form-group">
                <label class="req">Paid {lang('lr')} Commission</label>
                <div class="row">
            ...
            <div class="col-md-4 form-group">
                <label class="req">ToPay {lang('lr')} Commission</label>
                <div class="row">
                    <div class="col-sm-6 p_r_n">
            ...
            <div class="col-md-4 form-group">
                <label class="req">AccPay {lang('lr')} Commission</label>
                <div class="row">
                    <div class="col-sm-6 p_r_n">

        ...
        <table width="100%" class="border-collapse">
            <tbody>
                <tr class="border-bottom">
                    <td width="75%" align="center" valign="bottom" class="border-top">
                        <tr class="border-bottom">
                        <br />
                            <img src="assets/img/chakratravels-logo.jpg" alt="logo" width="500" height="50">
                        </tr>
                    </td>
                    ...
                    <td width="25%">
                        <table class="border-left" cellpadding="5">
                            ...
                            <tr>
                                <td>Date : {$summary->bookedAt|date_format:"%d-%m-%Y"}</td>
                            </tr>
                        </table>
                    </td>
                </tr>
                ...
                <tr>
                    <td width="70%">
                        ...
                        <table class="bordered">
                            <tr class="bold">
                                <td class="customer-care" align="center">Seal & Signature of Consignee</td>

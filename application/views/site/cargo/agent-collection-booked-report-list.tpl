<table width="99%">
    <tr>
        <td colspan="2" align="center"><b>Agent / Branch Collection : Based On Booked Date</b></td>
    </tr>
    <tr>
        <td width="50%">
            <b>Report Date : </b>
    ...
    <tr>
        <td width="50%">{if $branchName}<b>Branch :</b> {$branchName}{if $userName}, <b>User :</b> {$userName}{/if}{/if}</td>

...
<body>
    <table width="100%" cellpadding="3">   
        ...
        <tr>            
            ...
            {else}
                <td align="center" class="bold f17">{if $namespace eq 'tvlscargo'}THIRUPPATHI VENKATACHALAPATHI LORRY SERVICE CHENNAI PVT LTD{else}{$namespace_name}{/if}</td>
            {/if}
        </tr>
        <tr>
    ...
    <table width="100%" cellpadding="3">
        ...
        <tr>
            <td align="left" width="100%" colspan="2">
                ...
                <span class="f11 bold">{$transitCloseMinutes|addMinutesToDateTime:$summary->bookedAt:'d-m-Y'}</span>  
            </td>     	
        </tr>
        {/if} 
        <tr>

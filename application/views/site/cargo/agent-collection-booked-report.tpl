<div class="brand_top">
    <h3>Agent / Branch Collection Report : Booked Date</h3>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <div class="col-md-12">
                                        <div class="">
                                            <div id="search-panel">
                                                <form id="collection_report" method="post" name="collection_report" action="cargo/agent-collection-booked-report-list" onsubmit="return false;">                                                  <div class="row">
                                                        <div class="form-group col-md-2">
                                                            <label for="collection_rpt_from">Booked Date From</label>
                                                        ...
                                                        <div class="form-group col-md-2">
                                                            <label for="collection_rpt_to">Booked Date To</label>
                                                            <div class="input-group">
                                                        ...
                                                        {if $action_rights['AGTB-COLL-ALL-BRANCH']>0}
                                                            <div class="form-group col-md-2">
...
<script>
    ...
    function branchSelected (select) {
        ...
        if (branchusers.length > 1) {
            branchusers.unshift(new Option('All Users', 'NA'));
        }
...
{literal}
    <script>
        ...
        function exportCargoCollection() {
            $('#export').val(1);
            $('#orgname').val($("#collection_rpt_to_org option:selected").text());
            $('#username').val($("#collection_rpt_users option:selected").text());
        ...
        function getCollectionReport() {
            ...
            data.orgname = $("#collection_rpt_to_org option:selected").text();
            data.filterType = $("#filterType").val();
            data.userCode = $("#collection_rpt_users").val();
            data.username = $("#collection_rpt_users option:selected").text();
            ...
            $.ajax({
                type: "POST",
                dataType: 'html',
                url: base_url + "cargo/agent-collection-booked-report-list",
                data: data,

<div class="brand_top">
    <h3>Agent / Branch Collection Report : Loaded Date</h3>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <div class="col-md-12">
                                        <div class="">
                                            <div id="search-panel">
                                                <form id="collection_report" method="post" name="collection_report" action="cargo/agent-collection-loaded-report-list" onsubmit="return false;">                                                  <div class="row">
                                                        <div class="form-group col-md-2">
                                                            <label for="collection_rpt_from">Loaded Date From</label>
                                                        ...
                                                        <div class="form-group col-md-2">
                                                            <label for="collection_rpt_to">Loaded Date To</label>
                                                            <div class="input-group">
                                                        ...
                                                        {if $action_rights['AGTL-COLL-ALL-BRANCH']>0}
                                                            <div class="form-group col-md-2">
    ...
    <script>
        ...
        function getCollectionReport() {
            ...
            $.ajax({
                type: "POST",
                dataType: 'html',
                url: base_url + "cargo/agent-collection-loaded-report-list",
                data: data,

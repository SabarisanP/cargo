...
<tr>
    <td width="65%">
    	...
    	<table width="100%" cellpadding="3" class="table bordered ">
            ...
            {/if}
            <tr>
                <td align="left" width="50%" style="font-weight:bold;">{$summary->fromOrganization->name}
                ...
                <td align="left" width="50%" style="font-weight:bold;">{$summary->toOrganization->name}
...
{*        {$summary->paymentType->name}*}
        ...
        <table align="center">
            <tr style="font-size:20px;font-weight: bold;">
                <td align="right" colspan="2" class="bold" style="padding-bottom: 20px;">{$payment_type_name|strtoupper}&nbsp;&nbsp;&nbsp;&nbsp;</td>
            </tr>

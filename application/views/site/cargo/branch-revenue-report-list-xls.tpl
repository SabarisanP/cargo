<table border='1'>
    <tr>
        <td  colspan="12" align="center"><b>Branch Revenue Report</b></td>
    </tr>
    <tr>
        <td colspan="6">Report Date : {$smarty.request.fromDate|date_format:$ns_date_format}  to {$smarty.request.toDate|date_format:$ns_date_format} </td>
...
<table class="table table-bordered " border='1'>
    <thead>
        <tr style="background-color: #64b92a;" nowrap>
            {if $smarty.request.pcrFilterType == 'DETAILS'}
            <td align="center" rowspan="2">{lang('cargo_code_term')}</td>
            <td align="center" rowspan="2">Cargo Payement Status</td>
            {/if}
            {if $smarty.request.pcrFilterType == 'SUMMARY'}
            <td align="center" rowspan="2">Branch Name</td>
            {/if}
    ...
    <tbody class="body_table">
        {foreach item=row from=$result}
            ...
            {if $smarty.request.pcrFilterType == 'DETAILS'}
                ...
                {assign var=tot_net_other value=$tot_net_other+$tot_other}{foreachelse}
            <tr>

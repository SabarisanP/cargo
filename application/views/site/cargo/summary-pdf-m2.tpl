...
<table width="100%">
    <tr>
        <td align="center">
            <img src="assets/img/clientlogo/{$namespace}.jpg" alt="logo">
        </td>
    </tr>
    <tr>
...
{*        {$summary->paymentType->name}*}
        ...
        {if $namespace == 'smroadlines'}
        <br/>
        <table cellpadding="2">
            {assign var="freightgst" value=(0.05 * $summary->totalAmount)}
            <tr>
                <td align="center">GST RCM <span class="bold">@5% RS.{$freightgst|number_format:2}</span> is payable by either Consigner/Consignee</td>
            </tr>
        </table>
        {/if}
    </td>

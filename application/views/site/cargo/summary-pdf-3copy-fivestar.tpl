            ...
            <tbody>
                <tr>
                    <td colspan="2">
                        ...
                        <tr>
                            <td width="10%">
                                <img src="assets/img/clientlogo/fivestar.jpg" height="50">
                            </td>
                            <td width="78%" align="center" class="font-10">
                                <span style="font-weight:bold; font-size: 13px;">{$namespace_name}</span><br>
                                <b>Parcel Booking Receipt</b><br>
                            ...
                            <td width="12%">
                                <tcpdf method="write2DBarcode" params="{$barcode}" />
                            </td>            
                        </tr>
                        </table>
                    </td>

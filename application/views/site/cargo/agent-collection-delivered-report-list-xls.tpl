<table border='1'>
    ...
    <tr>
        <td colspan="6" align="center"><b>Agent / Branch Collection : Based On Delivered Date</b></td>
    </tr>
    <tr>
            ...
            <table class="table table-bordered" width="99%">
                <thead>
                    <tr class="success">
                        ...
                        <td align="center"><b>Delivered Date</b></td>
                    ...
                    {foreach key=user_name item=list from=$userwise}
                        ...
                        {foreach item=row from=$list}
                            <tr>
                                ...
                                <td align="left" nowrap>{$row->delivered_at|date_format:$ns_date_format}</td>

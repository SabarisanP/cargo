...
<table width="100%">
    ...
    {else if $namespace == "ragavendraparcel"}
        <tr>
            <td width="85%" align="center">
    ...
    {else if $namespace == "abexpress"}
        <tr>
            <td width="100%" align="center">
                <img src="assets/img/abexpress-LR-Header.jpg" alt="Header" style="max-width: 100%;"><br>
            </td>
        </tr>
    {else if $namespace == "velavaparcel"}
        <tr>
            <td width="100%" align="center">
                <img src="assets/img/velavaparcel-header.jpeg" alt="Header" style="max-width: 100%;"><br>
            </td>
        </tr>
    {else if $namespace == "gotour"}
        <tr>
            <td width="100%" align="center">
                <img src="assets/img/gotour-header.jpg" alt="Header" style="max-width: 100%;"><br>
            </td>
        </tr>
    {else if $namespace == "appletravels"}
        <tr>
            <td width="100%" align="center">
                <img src="assets/img/clientlogo/appletravels-header.jpg" alt="Header" style="max-width: 100%;"><br>
            </td>
        </tr>
        {else if $namespace == "mbttransport"}
            <table style="border: 1px solid #9a9a9a;">
                <tr>
                    <td width="30%" align="left"><br><br>
                        <span  style="font-size:10px;"><b>Contact :</b> 9880186184 ,</span><br>
                        <span  style="font-size:10px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 8867786184</span>
                    </td>
                    <td width="35%" align="left">
                        <br> <br>
                        <img src="assets/img/mbttransport-logo.png" alt="logo" style="width: 150px;"><br>
                    </td>
                    <td width="35%" align="left"><br><br>
                        <span  style="font-size:10px;"><b>Email :</b></span><span style="font-size:11px;"> mbttransport06@gmail.com</span> <br>
                        <span  style="font-size:10px;"><b>Website :</b></span><span style="font-size:11px;"> www.mbttransport.in &nbsp; &nbsp; &nbsp; &nbsp;</span><br>
                        <span  style="font-size:10px;"><b>TRANSIN :</b> 29DZLPD0662N1ZW</span>
                    </td>
                </tr>
                <tr>
                    <td width="25%"></td>
                    <td width="50%" align="left">
                       <span  style="font-size:10px;"> {$summary->fromOrganization->address1|capitalize},
                        {$summary->fromOrganization->address2|capitalize} &nbsp; {$summary->fromOrganization->contact}</span>
                    </td>
                    <td width="25%"></td>
                </tr>
                <br>
            </table><br><br>
    {else if $namespace == "applebus"}
            <tr>
                <td width="100%" align="center">
                    <img src="assets/img/clientlogo/applebus-header.jpg" alt="Header" style="max-width: 100%;"><br>
                </td>
            </tr>
    {else if $namespace == "jahantransport"}
        <tr>
            <td width="100%" align="center">
                <img src="assets/img/clientlogo/jahan-transport-print-header.jpg" alt="Header" style="max-width: 100%;"><br>
            </td>
        </tr>
    {else if $namespace == "srisendhursps"}
        <tr>
            <td width="100%" align="center">
                <img src="assets/img/clientlogo/srisendhursps-print-header.jpg" alt="Header" style="max-width: 100%;"><br>
            </td>
        </tr>
    {else if $namespace == "vijaytourist"}
        <tr>
            <td width="100%" align="center">
...
<table width="100%">
    <tr>
        <td width="65%">
            ...
            <br><br>
            {if $namespace === 'mbttransport'}
                <table width="100%" cellpadding="2" class="table bordered" style="margin-top: 5px;">
                    <tbody class="body_table">
                      
                        <tr>
                            <td width="50%"><span class="bold font-10">Consignor: </span>&nbsp;{$summary->fromCustomer->name}</td>
                            <td width="50%"><span class="bold font-10">Consignee: </span>&nbsp;{$summary->toCustomer->name}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td align="left" width="50%"class="bold font-10">From : &nbsp; {$summary->fromOrganization->name} - <span class="bold font-12">{$summary->fromOrganization->contact}</span></td>
                            <td align="left" width="50%"class="bold font-10">To : &nbsp;  {$summary->toOrganization->name}- <span class="bold font-12">{$summary->toOrganization->contact}</span></td>
                        </tr>
        ...
        <table align="left" class="table" cellpadding="1">
            ...
            <tr>
                <td align="left">
                    <b>Bank Name :</b>&nbsp;State Bank Of India, <b>Branch : </b>&nbsp;Thiruthangal
                </td>
            </tr>
            <tr>
                <td align="left">
        ...
        <td width="32%" valign="top">
            ...
            <table align="">
                <tr style="font-size:10px;font-weight: bold;">
                    {if in_array($namespace, ["appletravels","applebus"])}
                        <td align="left" width="35%" class="bold">Delivery To :</td>
                        <td align="left" width="65%">{$summary->toOrganization->name}</td>
                    {else}
            ...
            <table width="100%" cellpadding="3" class="table" style="border: 0.1px solid #000;">
                <tbody class="body_table">
                    ...
                    <tr>
                        ...
                        <td align="left" width="50%">&nbsp;&nbsp;&nbsp;&nbsp;{if $summary->paymentType->code == "INP" && $hideCargoFreight == 1}-{else}{$summary->totalAmount|number_format:2}{/if}</td>
                    </tr>
                    <tr>
                        <td align="left" width="50%" class="bold" style="border-right: 0.1px solid #000;">L Charges</td>
                        <td align="left" width="50%">&nbsp;&nbsp;&nbsp;&nbsp;{if $summary->paymentType->code == "INP" && $hideCargoFreight == 1}-{else}{$summary->totalHandlingAmount|number_format:2}{/if}</td>
                    </tr>
                    {if $summary->pickupHandlingAmount>0}
                        <tr>
                            <td align="left" width="50%" class="bold" style="border-right: 0.1px solid #000;">Pickup Charges</td>
                            <td align="left" width="50%">&nbsp;&nbsp;&nbsp;&nbsp;{if $summary->paymentType->code == "INP" && $hideCargoFreight == 1}-{else}{$summary->pickupHandlingAmount|number_format:2}{/if}</td>
                        </tr>
                    {/if}
                    {if $summary->deliveryHandlingAmount>0}
                        <tr>
                            ...
                            <td align="left" width="50%">&nbsp;&nbsp;&nbsp;&nbsp;{if $summary->paymentType->code == "INP" && $hideCargoFreight == 1}-{else}{$summary->deliveryHandlingAmount|number_format:2}{/if}</td>
                        </tr>
                    {/if}
                    {if $summary->hamaliCharge > 0}
                        <tr>
                            <td align="left" width="50%" class="bold" style="border-right: 0.1px solid #000;">Hamali Charges</td>
                            <td align="left">&nbsp;&nbsp;&nbsp;&nbsp;{if $summary->paymentType->code == "INP" && $hideCargoFreight == 1}-{else}{$summary->hamaliCharge|number_format:2}{/if}</td>
                        </tr>
                    {/if}
                    ...
                    {if $summary->passCharge > 0}
                        <tr>
                            ...
                            <td align="left">&nbsp;&nbsp;&nbsp;&nbsp;{if $summary->paymentType->code == "INP" && $hideCargoFreight == 1}-{else}{$summary->passCharge|number_format:2}{/if}</td>
                        </tr>
                    {/if}
                    ...
                    {if $summary->docketCharge > 0}
                        <tr>
                            ...
                            <td align="left">&nbsp;&nbsp;&nbsp;&nbsp;{if $summary->paymentType->code == "INP" && $hideCargoFreight == 1}-{else}{$summary->docketCharge|number_format:2}{/if}</td>
                        </tr>
                    {/if}
                    {if isset($addons_mapped['PODCH'])}
                        <tr>
                            <td align="left" width="50%" class="bold" style="border-right: 0.1px solid #000;">POD Charges</td>
                            <td align="left">&nbsp;&nbsp;&nbsp;&nbsp;{if $summary->paymentType->code == "INP" && $hideCargoFreight == 1}-{else}{$addons_mapped['PODCH']->value|number_format:2}{/if}</td>
                        </tr>
                    {/if}
                    ...
                    {if $summary->totalUnloadHandlingAmount > 0}
                        <tr>
                            ...
                            <td align="left" width="50%">&nbsp;&nbsp;&nbsp;&nbsp;{if $summary->paymentType->code == "INP" && $hideCargoFreight == 1}-{else}{$summary->totalUnloadHandlingAmount|number_format:2}{/if}</td>
                        </tr>
                    {/if}
                    {if $summary->serviceCharge>0}
                        <tr>
                            <td align="left" width="50%" class="bold" style="border-right: 0.1px solid #000;">Service Charges</td>
                            <td align="left" width="50%">&nbsp;&nbsp;&nbsp;&nbsp;{if $summary->paymentType->code == "INP" && $hideCargoFreight == 1}-{else}{$summary->serviceCharge|number_format:2}{/if}</td>
                        </tr>
                    {/if}
                    {if $namespace == "panindia" }
                        <tr {if $summary->paymentType->code == 'PAD'}class="bold" style="font-size: 9px;" {/if}>
                            ...
                            <td align="left" width="50%">&nbsp;&nbsp;&nbsp;&nbsp;{($summary->totalAmount+$summary->totalHandlingAmount+$summary->totalUnloadHandlingAmount+$summary->pickupHandlingAmount+$summary->deliveryHandlingAmount+$summary->serviceCharge+$summary->hamaliCharge+$summary->passCharge+$summary->docketCharge + $addons_mapped['PODCH']->value + $addons_mapped['DMRCH']->value)|number_format:2}</td>
                        </tr>
                        <tr>
                    ...
                    {else}
                        ...
                        {if isset($addons_mapped['CNCTCH'])}
                            {assign var="con_charge" value=$addons_mapped['CNCTCH']->value}
                            {else}
                                {assign var="con_charge" value=0}
                            {/if}
                        {if isset($summary->tax->code)}
                            ...
                            {if $tax_computed->cgstValue != 0}
                                <tr>
                                    ...
                                    <td align="left">&nbsp;&nbsp;&nbsp;&nbsp;{if $summary->paymentType->code == "INP" && $hideCargoFreight == 1}-{else}{$tax_computed->cgstValue|number_format:2}{/if}</td>
                                </tr>
                            {/if}
                            {if $tax_computed->sgstValue != 0}
                                <tr>
                                    <td align="left" class="bold" style="border-right: 0.1px solid #000;">SGST</td>
                                    <td align="left">&nbsp;&nbsp;&nbsp;&nbsp;{if $summary->paymentType->code == "INP" && $hideCargoFreight == 1}-{else}{$tax_computed->sgstValue|number_format:2}{/if}</td>
                                </tr>
                            {/if}
                            {if $tax_computed->ugstValue != 0}
                                <tr>
                                    <td align="left" class="bold" style="border-right: 0.1px solid #000;">UGST</td>
                                    <td align="left">&nbsp;&nbsp;&nbsp;&nbsp;{if $summary->paymentType->code == "INP" && $hideCargoFreight == 1}-{else}{$tax_computed->ugstValue|number_format:2}{/if}</td>
                                </tr>
                            {/if}
                            {if $tax_computed->igstValue != 0}
                                <tr>
                                    <td align="left" class="bold" style="border-right: 0.1px solid #000;">IGST</td>
                                    <td align="left">&nbsp;&nbsp;&nbsp;&nbsp;{if $summary->paymentType->code == "INP" && $hideCargoFreight == 1}-{else}{$tax_computed->igstValue|number_format:2}{/if}</td>
                                </tr>
                            {/if}
                        {elseif $summary->serviceTax > 0}
                            <tr>
                                <td align="left" class="bold" style="border-right: 0.1px solid #000;">GST</td>
                                <td align="left">&nbsp;&nbsp;&nbsp;&nbsp;{if $summary->paymentType->code == "INP" && $hideCargoFreight == 1}-{else}{$summary->serviceTax|number_format:2}{/if}</td>
                            </tr>
                        {/if}
                        {if isset($addons_mapped['CNCTCH'])}
                            <tr>
                                <td align="left" width="50%" class="bold" style="border-right: 0.1px solid #000;">Connecting Charges</td>
                                <td align="left">&nbsp;&nbsp;&nbsp;&nbsp;{$addons_mapped['CNCTCH']->value|number_format:2}</td>
                            </tr>
                        {/if}
                        <tr {if $summary->paymentType->code == 'PAD'}class="bold" style="font-size: 9px;" {/if}>
                            <td align="left" width="50%" class="bold" style="border-right: 0.1px solid #000;">Net Amount</td>
                          
                            <td align="left" width="50%">&nbsp;&nbsp;&nbsp;&nbsp;{if $summary->paymentType->code == "INP" && $hideCargoFreight == 1}-{else}{($summary->totalAmount+$summary->totalHandlingAmount+$summary->totalUnloadHandlingAmount+$summary->pickupHandlingAmount+$summary->deliveryHandlingAmount+$summary->serviceCharge+$summary->serviceTax+$summary->hamaliCharge+$summary->passCharge+$summary->docketCharge + $addons_mapped['PODCH']->value + $addons_mapped['DMRCH']->value+$con_charge+$addons_mapped['RNDF']->value)|number_format:2}{/if}</td>
                        </tr>
                    {/if}
                    {* cumulation page 1 *}
                    <tr {if $summary->paymentType->code == 'PAD'}class="bold" style="font-size: 9px;" {/if}>
                        <td align="left" width="50%" class="bold" style="border-right: 0.1px solid #000;">Amount Paid</td>
                        <td align="left" width="50%">&nbsp;&nbsp;&nbsp;&nbsp;{if $summary->paymentType->code == "INP" && $hideCargoFreight == 1}-{else}{$summary->paymentAmount|number_format:2}{/if}</td>
                    </tr>
                    {assign var="balance_to_pay" value=($summary->totalAmount+$summary->totalHandlingAmount+$summary->totalUnloadHandlingAmount+$summary->pickupHandlingAmount+$summary->deliveryHandlingAmount+$summary->serviceCharge+$summary->serviceTax+$summary->hamaliCharge+$summary->passCharge+$summary->docketCharge + $addons_mapped['PODCH']->value + $addons_mapped['DMRCH']->value+$con_charge)-$summary->paymentAmount+ $addons_mapped['RNDF']->value}
                    {if $balance_to_pay>0}
                        <tr style="font-size: 9px;" class="bordered-new">
                            <td align="left" width="50%" class="bold">Amount Balance</td>
                            <td align="left" width="50%">&nbsp;&nbsp;<b>{if $summary->paymentType->code == "INP" && $hideCargoFreight == 1}-{else}{$balance_to_pay|number_format:2}{/if}</b></td>
                        </tr>
                    {/if}
                </tbody>
            </table>
                    ...
                    <tbody class="body_table">
                        ...
                        {if isset($addons_mapped['DMRCH'])}
                            <tr>
                                ...
                                <td align="left">&nbsp;&nbsp;&nbsp;&nbsp;{if $summary->paymentType->code == "INP" && $hideCargoFreight == 1}-{else}{$addons_mapped['DMRCH']->value|number_format:2}{/if}</td>
                            </tr>
                        {/if}
                        {if $summary->totalUnloadHandlingAmount > 0}
                            <tr>
